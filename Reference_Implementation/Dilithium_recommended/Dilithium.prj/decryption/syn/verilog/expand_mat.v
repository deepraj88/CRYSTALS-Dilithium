...
wire   [5:0] i_30_fu_246_p2;
reg   [5:0] i_30_reg_413;
wire    ap_CS_fsm_state2;
wire   [63:0] tmp_s_fu_252_p1;
reg   [63:0] tmp_s_reg_418;
wire   [0:0] tmp_fu_240_p2;
wire   [2:0] i_31_fu_263_p2;
reg   [2:0] i_31_reg_436;
wire    ap_CS_fsm_state4;
wire   [5:0] tmp_143_cast_fu_277_p1;
reg   [5:0] tmp_143_cast_reg_441;
wire   [0:0] exitcond1_fu_257_p2;
wire   [2:0] j_10_fu_287_p2;
reg   [2:0] j_10_reg_449;
wire    ap_CS_fsm_state5;
wire   [5:0] tmp_144_fu_316_p2;
reg   [5:0] tmp_144_reg_454;
wire   [0:0] exitcond_fu_281_p2;
wire   [13:0] tmp_148_cast_fu_321_p3;
reg   [13:0] tmp_148_cast_reg_459;
...
wire   [0:0] tmp_141_fu_328_p3;
wire   [7:0] output_assign_q0;
reg   [7:0] output_assign_load_reg_472;
wire    ap_CS_fsm_state11;
wire   [31:0] pos_3_fu_358_p2;
reg   [31:0] pos_3_reg_482;
reg   [4:0] s_address0;
reg    s_ce0;
reg    s_we0;
reg   [63:0] s_d0;
...
wire    grp_keccak_absorb_1_fu_234_ap_start;
wire    grp_keccak_absorb_1_fu_234_ap_done;
wire    grp_keccak_absorb_1_fu_234_ap_idle;
wire    grp_keccak_absorb_1_fu_234_ap_ready;
wire   [4:0] grp_keccak_absorb_1_fu_234_s_address0;
wire    grp_keccak_absorb_1_fu_234_s_ce0;
wire    grp_keccak_absorb_1_fu_234_s_we0;
wire   [63:0] grp_keccak_absorb_1_fu_234_s_d0;
wire   [5:0] grp_keccak_absorb_1_fu_234_m_address0;
wire    grp_keccak_absorb_1_fu_234_m_ce0;
reg   [5:0] i_reg_156;
...
wire   [8:0] ctr_1_fu_389_p2;
wire   [0:0] tmp_149_fu_383_p2;
reg    grp_keccak_squeezeblocks_3_fu_226_ap_start_reg;
wire    ap_CS_fsm_state8;
reg    grp_keccak_absorb_1_fu_234_ap_start_reg;
wire    ap_CS_fsm_state6;
wire    ap_CS_fsm_state7;
wire   [63:0] tmp_145_fu_336_p1;
wire   [63:0] tmp_146_fu_353_p1;
wire   [63:0] tmp_147_fu_364_p1;
wire   [63:0] tmp_155_cast_fu_405_p1;
wire   [7:0] tmp_201_cast_fu_307_p1;
wire   [22:0] tmp_21_fu_373_p4;
wire   [4:0] tmp_142_fu_269_p3;
wire   [1:0] tmp_140_fu_293_p1;
wire   [5:0] tmp_143_fu_297_p4;
wire   [5:0] tmp_145_cast_fu_312_p1;
wire   [31:0] pos_1_fu_341_p2;
wire   [31:0] pos_2_fu_347_p2;
wire   [6:0] tmp_148_fu_369_p1;
wire   [13:0] tmp_154_cast_fu_396_p1;
wire   [13:0] tmp_150_fu_400_p2;
reg   [11:0] ap_NS_fsm;
...
#0 grp_keccak_absorb_1_fu_234_ap_start_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_keccak_absorb_1_fu_234_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state6)) begin
            grp_keccak_absorb_1_fu_234_ap_start_reg <= 1'b1;
        end else if ((grp_keccak_absorb_1_fu_234_ap_ready == 1'b1)) begin
            grp_keccak_absorb_1_fu_234_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_141_fu_328_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_257_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        tmp_143_cast_reg_441[4 : 2] <= tmp_143_cast_fu_277_p1[4 : 2];
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_keccak_squeezeblocks_3_fu_226_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        tmp_148_cast_reg_459[13 : 8] <= tmp_148_cast_fu_321_p3[13 : 8];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        if ((tmp_149_fu_383_p2 == 1'd0)) begin
            ap_phi_mux_ctr_be_phi_fu_218_p4 = ctr_reg_202;
        end else if ((tmp_149_fu_383_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((tmp_149_fu_383_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        output_assign_address0 = tmp_146_fu_353_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        output_assign_address0 = tmp_145_fu_336_p1;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (grp_keccak_absorb_1_fu_234_ap_done == 1'b1))) begin
...
assign ctr_1_fu_389_p2 = (ctr_reg_202 + 9'd1);

assign exitcond1_fu_257_p2 = ((i_1_reg_167 == 3'd5) ? 1'b1 : 1'b0);

assign exitcond_fu_281_p2 = ((j_reg_179 == 3'd4) ? 1'b1 : 1'b0);

assign grp_keccak_absorb_1_fu_234_ap_start = grp_keccak_absorb_1_fu_234_ap_start_reg;

assign grp_keccak_squeezeblocks_3_fu_226_ap_start = grp_keccak_squeezeblocks_3_fu_226_ap_start_reg;

assign i_30_fu_246_p2 = (i_reg_156 + 6'd1);

assign i_31_fu_263_p2 = (i_1_reg_167 + 3'd1);

assign j_10_fu_287_p2 = (j_reg_179 + 3'd1);

assign mat_vec_coeffs_address0 = tmp_155_cast_fu_405_p1;

assign mat_vec_coeffs_d0 = tmp_21_fu_373_p4;

assign output_assign_address1 = tmp_147_fu_364_p1;

assign pos_1_fu_341_p2 = (32'd1 + pos_reg_190);

assign pos_2_fu_347_p2 = (32'd2 + pos_reg_190);

assign pos_3_fu_358_p2 = (32'd3 + pos_reg_190);

assign rho_address0 = tmp_s_fu_252_p1;

assign tmp_140_fu_293_p1 = j_reg_179[1:0];

assign tmp_141_fu_328_p3 = ctr_reg_202[32'd8];

assign tmp_142_fu_269_p3 = {{i_1_reg_167}, {2'd0}};

assign tmp_143_cast_fu_277_p1 = tmp_142_fu_269_p3;

assign tmp_143_fu_297_p4 = {{{tmp_140_fu_293_p1}, {1'd0}}, {i_1_reg_167}};

assign tmp_144_fu_316_p2 = (tmp_143_cast_reg_441 + tmp_145_cast_fu_312_p1);

assign tmp_145_cast_fu_312_p1 = j_reg_179;

assign tmp_145_fu_336_p1 = pos_reg_190;

assign tmp_146_fu_353_p1 = pos_1_fu_341_p2;

assign tmp_147_fu_364_p1 = pos_2_fu_347_p2;

assign tmp_148_cast_fu_321_p3 = {{tmp_144_reg_454}, {8'd0}};

assign tmp_148_fu_369_p1 = output_assign_q1[6:0];

assign tmp_149_fu_383_p2 = ((tmp_21_fu_373_p4 < 23'd8380417) ? 1'b1 : 1'b0);

assign tmp_150_fu_400_p2 = (tmp_148_cast_reg_459 + tmp_154_cast_fu_396_p1);

assign tmp_154_cast_fu_396_p1 = ctr_reg_202;

assign tmp_155_cast_fu_405_p1 = tmp_150_fu_400_p2;

assign tmp_201_cast_fu_307_p1 = tmp_143_fu_297_p4;

assign tmp_21_fu_373_p4 = {{{tmp_148_fu_369_p1}, {output_assign_q0}}, {output_assign_load_reg_472}};
...
always @ (posedge ap_clk) begin
    ...
    tmp_143_cast_reg_441[1:0] <= 2'b00;
    tmp_143_cast_reg_441[5] <= 1'b0;
    tmp_148_cast_reg_459[7:0] <= 8'b00000000;
end
