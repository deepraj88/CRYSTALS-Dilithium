...
polyveck_freeze::polyveck_freeze(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_a_assign_8_cast_fu_151_p1);
    sensitive << ( tmp_62_fu_141_p4 );

    SC_METHOD(thread_a_assign_9_fu_189_p2);
    sensitive << ( tmp12_fu_181_p3 );
    sensitive << ( tmp_41_i_i_i_cast_fu_171_p1 );
    ...
    SC_METHOD(thread_i_15_fu_89_p2);
    sensitive << ( i_reg_61 );

    SC_METHOD(thread_i_16_fu_113_p2);
    ...
    sensitive << ( tmp_63_fu_175_p2 );

    SC_METHOD(thread_tmp_41_i_i_i_cast_fu_171_p1);
    sensitive << ( tmp_41_i_i_i_fu_165_p2 );

    SC_METHOD(thread_tmp_41_i_i_i_fu_165_p2);
    sensitive << ( t_cast_fu_137_p1 );
    sensitive << ( a_assign_8_cast_fu_151_p1 );

    SC_METHOD(thread_tmp_61_fu_123_p2);
    sensitive << ( tmp_68_cast_reg_224 );
    sensitive << ( tmp_i_cast_fu_119_p1 );

    SC_METHOD(thread_tmp_62_fu_141_p4);
    sensitive << ( v_vec_coeffs_q0 );

    SC_METHOD(thread_tmp_63_fu_175_p2);
    sensitive << ( tmp_i_i_i_fu_155_p4 );

    SC_METHOD(thread_tmp_64_fu_195_p3);
    sensitive << ( a_assign_9_reg_242 );

    SC_METHOD(thread_tmp_68_cast_fu_103_p1);
    sensitive << ( tmp_s_fu_95_p3 );

    SC_METHOD(thread_tmp_69_cast_fu_128_p1);
    sensitive << ( tmp_61_fu_123_p2 );
    ...
    sensitive << ( tmp_69_cast_fu_128_p1 );
    ...
    sc_trace(mVcdFile, i_15_fu_89_p2, "i_15_fu_89_p2");
    sc_trace(mVcdFile, i_15_reg_219, "i_15_reg_219");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, tmp_68_cast_fu_103_p1, "tmp_68_cast_fu_103_p1");
    sc_trace(mVcdFile, tmp_68_cast_reg_224, "tmp_68_cast_reg_224");
    sc_trace(mVcdFile, tmp_fu_83_p2, "tmp_fu_83_p2");
    sc_trace(mVcdFile, i_16_fu_113_p2, "i_16_fu_113_p2");
    sc_trace(mVcdFile, i_16_reg_232, "i_16_reg_232");
    ...
    sc_trace(mVcdFile, a_assign_9_fu_189_p2, "a_assign_9_fu_189_p2");
    sc_trace(mVcdFile, a_assign_9_reg_242, "a_assign_9_reg_242");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, i_reg_61, "i_reg_61");
    sc_trace(mVcdFile, i_i_reg_72, "i_i_reg_72");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, tmp_69_cast_fu_128_p1, "tmp_69_cast_fu_128_p1");
    sc_trace(mVcdFile, tmp_s_fu_95_p3, "tmp_s_fu_95_p3");
    sc_trace(mVcdFile, tmp_i_cast_fu_119_p1, "tmp_i_cast_fu_119_p1");
    sc_trace(mVcdFile, tmp_61_fu_123_p2, "tmp_61_fu_123_p2");
    sc_trace(mVcdFile, t_fu_133_p1, "t_fu_133_p1");
    sc_trace(mVcdFile, tmp_62_fu_141_p4, "tmp_62_fu_141_p4");
    sc_trace(mVcdFile, t_cast_fu_137_p1, "t_cast_fu_137_p1");
    sc_trace(mVcdFile, a_assign_8_cast_fu_151_p1, "a_assign_8_cast_fu_151_p1");
    sc_trace(mVcdFile, tmp_41_i_i_i_fu_165_p2, "tmp_41_i_i_i_fu_165_p2");
    sc_trace(mVcdFile, tmp_i_i_i_fu_155_p4, "tmp_i_i_i_fu_155_p4");
    sc_trace(mVcdFile, tmp_63_fu_175_p2, "tmp_63_fu_175_p2");
    sc_trace(mVcdFile, tmp12_fu_181_p3, "tmp12_fu_181_p3");
    sc_trace(mVcdFile, tmp_41_i_i_i_cast_fu_171_p1, "tmp_41_i_i_i_cast_fu_171_p1");
    sc_trace(mVcdFile, tmp_64_fu_195_p3, "tmp_64_fu_195_p3");
...
void polyveck_freeze::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(tmp_i_fu_107_p2.read(), ap_const_lv1_1) && 
        ...
        i_reg_61 = i_15_reg_219.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_reg_61 = ap_const_lv3_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        a_assign_9_reg_242 = a_assign_9_fu_189_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_15_reg_219 = i_15_fu_89_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_16_reg_232 = i_16_fu_113_p2.read();
    }
    if ((esl_seteq<1,1,1>(tmp_fu_83_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        tmp_68_cast_reg_224 = tmp_68_cast_fu_103_p1.read();
    }
    if ((esl_seteq<1,1,1>(tmp_i_fu_107_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
        v_vec_coeffs_addr_reg_237 =  (sc_lv<11>) (tmp_69_cast_fu_128_p1.read());
    }
}

void polyveck_freeze::thread_a_assign_8_cast_fu_151_p1() {
    a_assign_8_cast_fu_151_p1 = esl_zext<24,9>(tmp_62_fu_141_p4.read());
}

void polyveck_freeze::thread_a_assign_9_fu_189_p2() {
    a_assign_9_fu_189_p2 = (!tmp12_fu_181_p3.read().is_01() || !tmp_41_i_i_i_cast_fu_171_p1.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp12_fu_181_p3.read()) + sc_bigint<32>(tmp_41_i_i_i_cast_fu_171_p1.read()));
}
...
void polyveck_freeze::thread_i_15_fu_89_p2() {
    i_15_fu_89_p2 = (!i_reg_61.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(i_reg_61.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void polyveck_freeze::thread_i_16_fu_113_p2() {
    i_16_fu_113_p2 = (!i_i_reg_72.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_i_reg_72.read()) + sc_biguint<9>(ap_const_lv9_1));
}
...
void polyveck_freeze::thread_tmp12_fu_181_p3() {
    tmp12_fu_181_p3 = esl_concat<10,22>(ap_const_lv10_3FE, tmp_63_fu_175_p2.read());
}

void polyveck_freeze::thread_tmp_41_i_i_i_cast_fu_171_p1() {
    tmp_41_i_i_i_cast_fu_171_p1 = esl_sext<32,24>(tmp_41_i_i_i_fu_165_p2.read());
}

void polyveck_freeze::thread_tmp_41_i_i_i_fu_165_p2() {
    tmp_41_i_i_i_fu_165_p2 = (!t_cast_fu_137_p1.read().is_01() || !a_assign_8_cast_fu_151_p1.read().is_01())? sc_lv<24>(): (sc_biguint<24>(t_cast_fu_137_p1.read()) - sc_biguint<24>(a_assign_8_cast_fu_151_p1.read()));
}

void polyveck_freeze::thread_tmp_61_fu_123_p2() {
    tmp_61_fu_123_p2 = (!tmp_i_cast_fu_119_p1.read().is_01() || !tmp_68_cast_reg_224.read().is_01())? sc_lv<12>(): (sc_biguint<12>(tmp_i_cast_fu_119_p1.read()) + sc_biguint<12>(tmp_68_cast_reg_224.read()));
}

void polyveck_freeze::thread_tmp_62_fu_141_p4() {
    tmp_62_fu_141_p4 = v_vec_coeffs_q0.read().range(31, 23);
}

void polyveck_freeze::thread_tmp_63_fu_175_p2() {
    tmp_63_fu_175_p2 = (tmp_i_i_i_fu_155_p4.read() | ap_const_lv22_1FFF);
}

void polyveck_freeze::thread_tmp_64_fu_195_p3() {
    tmp_64_fu_195_p3 = a_assign_9_reg_242.read().range(31, 31);
}

void polyveck_freeze::thread_tmp_68_cast_fu_103_p1() {
    tmp_68_cast_fu_103_p1 = esl_zext<12,11>(tmp_s_fu_95_p3.read());
}

void polyveck_freeze::thread_tmp_69_cast_fu_128_p1() {
    tmp_69_cast_fu_128_p1 = esl_zext<64,12>(tmp_61_fu_123_p2.read());
}
...
void polyveck_freeze::thread_tmp_i_i_cast_cast_fu_202_p3() {
    tmp_i_i_cast_cast_fu_202_p3 = (!tmp_64_fu_195_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_64_fu_195_p3.read()[0].to_bool())? ap_const_lv32_7FE001: ap_const_lv32_0);
}
...
void polyveck_freeze::thread_v_vec_coeffs_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        ...
        v_vec_coeffs_address0 =  (sc_lv<11>) (tmp_69_cast_fu_128_p1.read());
    } else {
...
void polyveck_freeze::thread_v_vec_coeffs_d0() {
    v_vec_coeffs_d0 = (!a_assign_9_reg_242.read().is_01() || !tmp_i_i_cast_cast_fu_202_p3.read().is_01())? sc_lv<32>(): (sc_biguint<32>(a_assign_9_reg_242.read()) + sc_biguint<32>(tmp_i_i_cast_cast_fu_202_p3.read()));
}
