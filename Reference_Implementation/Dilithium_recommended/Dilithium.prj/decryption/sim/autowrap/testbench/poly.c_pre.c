# 1 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
...
# 2 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c" 2
...
void shake256(unsigned char *output,
              ...
              const unsigned char *input,
              unsigned long long inlen);
# 3 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c" 2
# 1 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/params.h" 1
# 4 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c" 2
...
# 5 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c" 2
...
# 6 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c" 2
...
# 7 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c" 2
# 16 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_freeze(poly *a) {
  unsigned int i;
...
# 32 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_add(poly *c, const poly *a, const poly *b) {
  unsigned int i;
...
# 50 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_sub(poly *c, const poly *a, const poly *b) {
  unsigned int i;
...
# 65 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_neg(poly *a) {
  unsigned int i;
...
# 80 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_shiftl(poly *a, unsigned int k) {
  unsigned int i;
...
# 94 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_ntt(poly *a) {
  ntt(a->coeffs);
}
# 105 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_invntt_montgomery(poly *a) {
  invntt_frominvmont(a->coeffs);
}
# 120 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_pointwise_invmontgomery(poly *c, const poly *a, const poly *b) {
  unsigned int i;
...
# 138 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
int poly_chknorm(const poly *a, uint32_t B) {
  unsigned int i;
  int32_t t;
...
# 168 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_uniform(poly *a, unsigned char *buf) {
...
# 198 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
...
# 243 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_uniform_eta(poly *a,
                      const unsigned char seed[32U],
                      unsigned char nonce)
{
...
# 282 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
...
# 330 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void poly_uniform_gamma1m1(poly *a,
                           const unsigned char seed[32U + 48U],
                           uint16_t nonce)
{
...
# 368 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyeta_pack(unsigned char *r, const poly *a) {
  ...
  unsigned int i;
  unsigned char t[8];
# 398 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
  for(i = 0; i < 256U/2; ++i) {
...
# 416 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyeta_unpack(poly *r, const unsigned char *a) {
  unsigned int i;
# 440 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
  for(i = 0; i < 256U/2; ++i) {
...
# 459 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyt1_pack(unsigned char *r, const poly *a) {
...
# 487 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyt1_unpack(poly *r, const unsigned char *a) {
  unsigned int i;
...
# 512 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyt0_pack(unsigned char *r, const poly *a) {
  unsigned int i;
  uint32_t t[4];
...
# 545 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyt0_unpack(poly *r, const unsigned char *a) {
  unsigned int i;
...
# 581 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyz_pack(unsigned char *r, const poly *a) {
...
# 615 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyz_unpack(poly *r, const unsigned char *a) {
  unsigned int i;
...
# 644 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/poly.c"
void polyw1_pack(unsigned char *r, const poly *a) {
  unsigned int i;
