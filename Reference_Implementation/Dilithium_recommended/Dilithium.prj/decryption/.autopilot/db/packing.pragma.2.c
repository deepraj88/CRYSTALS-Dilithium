# 1 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/Dilithium.prj/decryption/.autopilot/db/packing.pragma.1.c"
# 1 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/Dilithium.prj/decryption/.autopilot/db/packing.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/home/dss545/vivado_hls/CRYSTALS-Dilithium/Reference_Implementation/Dilithium_recommended/Dilithium.prj/decryption/.autopilot/db/packing.pragma.1.c" 2
# 1 "packing.c"
# 1 "packing.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
...
void pack_pk(unsigned char pk[(32U + 5U*((256U*(23U - 14U))/8))],
             const unsigned char rho[32U],
             const polyveck *t1)
{_ssdm_SpecArrayDimSize(pk, 1472);_ssdm_SpecArrayDimSize(rho, 32);
  unsigned int i;
...
{_ssdm_SpecArrayDimSize(rho, 32);_ssdm_SpecArrayDimSize(pk, 1472);
  unsigned int i;
...
void pack_sk(unsigned char sk[(2*32U + (4U + 5U)*((256U*4U)/8) + 48U + 5U*((256U*14U)/8))],
             ...
             const polyveck *s2,
             const polyveck *t0)
{_ssdm_SpecArrayDimSize(sk, 3504);_ssdm_SpecArrayDimSize(rho, 32);_ssdm_SpecArrayDimSize(key, 32);_ssdm_SpecArrayDimSize(tr, 48);
  unsigned int i;
...
void unpack_sk(unsigned char rho[32U],
               ...
               polyveck *t0,
               const unsigned char sk[(2*32U + (4U + 5U)*((256U*4U)/8) + 48U + 5U*((256U*14U)/8))])
{_ssdm_SpecArrayDimSize(rho, 32);_ssdm_SpecArrayDimSize(key, 32);_ssdm_SpecArrayDimSize(tr, 48);_ssdm_SpecArrayDimSize(sk, 3504);
  unsigned int i;
...
void pack_sig(unsigned char sig[(4U*((256U*(23U - 3))/8) + (96U + 5U) + (256U/8 + 8))],
              ...
              const polyveck *h,
              const poly *c)
{_ssdm_SpecArrayDimSize(sig, 2701);
  unsigned int i, j, k;
  uint64_t signs, mask;
