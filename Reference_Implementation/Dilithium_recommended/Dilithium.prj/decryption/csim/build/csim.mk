...
HLS_SOURCES = ../../../../aes.c ../../../../newtest_sign.c ../../../../fips202.c ../../../../ntt.c ../../../../packing.c ../../../../poly.c ../../../../polyvec.c ../../../../reduce.c ../../../../rng.c ../../../../rounding.c ../../../../sign.c
...
$(ObjDir)/newtest_sign.o: ../../../../newtest_sign.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../newtest_sign.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
