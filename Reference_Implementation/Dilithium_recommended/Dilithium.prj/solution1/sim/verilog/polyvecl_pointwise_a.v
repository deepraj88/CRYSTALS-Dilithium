...
wire   [8:0] i_20_fu_268_p2;
reg   [8:0] i_20_reg_648;
...
wire   [11:0] tmp_44_fu_315_p2;
reg   [11:0] tmp_44_reg_673;
wire    ap_CS_fsm_state5;
wire   [31:0] t_fu_320_p2;
reg   [31:0] t_reg_678;
wire   [54:0] t_2_fu_328_p2;
reg   [54:0] t_2_reg_683;
...
wire  signed [31:0] tmp_54_fu_454_p1;
reg  signed [31:0] tmp_54_reg_724;
wire   [31:0] t_6_fu_458_p2;
reg   [31:0] t_6_reg_729;
wire    ap_CS_fsm_state12;
wire   [54:0] t_7_fu_466_p2;
reg   [54:0] t_7_reg_734;
wire    ap_CS_fsm_state13;
wire   [8:0] i_22_fu_510_p2;
reg   [8:0] i_22_reg_742;
wire    ap_CS_fsm_state15;
reg   [10:0] w_coeffs_addr_2_reg_747;
wire   [0:0] tmp_i3_40_fu_504_p2;
wire   [2:0] i_3_fu_535_p2;
wire   [8:0] i_21_fu_554_p2;
reg   [8:0] i_21_reg_765;
wire    ap_CS_fsm_state17;
reg   [10:0] w_coeffs_addr_reg_770;
wire   [0:0] tmp_s_fu_548_p2;
wire   [24:0] t_5_fu_618_p2;
reg   [24:0] t_5_reg_775;
...
wire   [63:0] tmp_46_fu_288_p1;
wire   [63:0] tmp_i_37_fu_274_p1;
...
wire   [63:0] tmp_i2_42_fu_516_p1;
wire   [63:0] tmp_56_cast_fu_569_p1;
wire   [31:0] tmp_i_i_fu_360_p1;
wire   [31:0] tmp_172_i_fu_541_p2;
wire  signed [31:0] t_7_cast_fu_624_p1;
wire   [10:0] tmp_42_fu_238_p3;
wire   [4:0] tmp_43_fu_250_p3;
wire   [12:0] tmp_45_fu_279_p4;
wire   [31:0] a_assign_fu_301_p0;
wire   [22:0] a_assign_fu_301_p1;
wire   [11:0] tmp_i_cast_fu_311_p1;
wire   [31:0] t_2_fu_328_p1;
wire   [55:0] t_4_cast_cast_fu_341_p1;
wire   [55:0] a_assign_cast_fu_338_p1;
wire   [55:0] t_3_fu_344_p2;
wire   [23:0] tmp_47_fu_350_p4;
wire   [5:0] tmp_cast_fu_371_p1;
wire   [5:0] tmp_48_fu_375_p2;
wire   [10:0] tmp_49_fu_388_p3;
wire   [13:0] tmp_i3_cast_fu_416_p1;
wire   [13:0] tmp_52_fu_420_p2;
wire   [11:0] tmp_i3_cast1_fu_412_p1;
wire   [11:0] tmp_53_fu_430_p2;
wire   [31:0] a_assign_3_fu_448_p0;
wire   [22:0] a_assign_3_fu_448_p1;
wire   [31:0] t_7_fu_466_p1;
wire   [55:0] t_10_cast_cast_fu_480_p1;
wire   [55:0] a_assign_3_cast8_fu_477_p1;
wire   [55:0] t_8_fu_483_p2;
wire   [23:0] tmp_55_fu_489_p4;
wire   [11:0] tmp_i2_cast_fu_521_p1;
wire   [11:0] tmp_56_fu_525_p2;
wire   [11:0] tmp_26_cast_fu_560_p1;
wire   [11:0] tmp_50_fu_564_p2;
wire   [22:0] t_4_fu_574_p1;
wire   [8:0] tmp_51_fu_582_p4;
wire   [21:0] tmp_i1_fu_596_p3;
wire   [23:0] t_6_cast_fu_578_p1;
wire   [23:0] a_assign_2_cast_fu_592_p1;
wire   [23:0] tmp_42_i_fu_608_p2;
wire  signed [24:0] tmp_42_i_cast_fu_614_p1;
...
wire   [54:0] t_2_fu_328_p10;
wire   [54:0] t_7_fu_466_p10;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_fu_262_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        i_reg_184 <= 3'd1;
    end else if (((1'b1 == ap_CS_fsm_state15) & (tmp_i3_40_fu_504_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_i3_40_fu_504_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state15))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        t_coeffs_address0 = tmp_i2_42_fu_516_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        u_vec_coeffs_address0 = tmp_46_fu_288_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        v_vec_coeffs_address0 = tmp_i_37_fu_274_p1;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state15 : begin
            if (((1'b1 == ap_CS_fsm_state15) & (tmp_i3_40_fu_504_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else begin
...
assign a_assign_2_cast_fu_592_p1 = tmp_51_fu_582_p4;

assign a_assign_3_cast8_fu_477_p1 = a_assign_3_reg_719;
...
assign i_20_fu_268_p2 = (i_i_reg_172 + 9'd1);

assign i_21_fu_554_p2 = (i_1_reg_219 + 9'd1);

assign i_22_fu_510_p2 = (i_i2_reg_208 + 9'd1);

assign i_2_fu_406_p2 = (i_i1_reg_196 + 9'd1);

assign i_3_fu_535_p2 = (i_reg_184 + 3'd1);

assign t_10_cast_cast_fu_480_p1 = t_7_reg_734;

assign t_2_fu_328_p1 = t_2_fu_328_p10;

assign t_2_fu_328_p10 = t_reg_678;

assign t_2_fu_328_p2 = (55'd8380417 * t_2_fu_328_p1);

assign t_3_fu_344_p2 = (t_4_cast_cast_fu_341_p1 + a_assign_cast_fu_338_p1);

assign t_4_cast_cast_fu_341_p1 = t_2_reg_683;

assign t_4_fu_574_p1 = w_coeffs_q0[22:0];

assign t_5_fu_618_p2 = ($signed(tmp_42_i_cast_fu_614_p1) + $signed(tmp_i1_cast_fu_604_p1));

assign t_6_cast_fu_578_p1 = t_4_fu_574_p1;

assign t_6_fu_458_p2 = ($signed(32'd4236238847) * $signed(tmp_54_reg_724));

assign t_7_cast_fu_624_p1 = $signed(t_5_reg_775);

assign t_7_fu_466_p1 = t_7_fu_466_p10;

assign t_7_fu_466_p10 = t_6_reg_729;

assign t_7_fu_466_p2 = (55'd8380417 * t_7_fu_466_p1);

assign t_8_fu_483_p2 = (t_10_cast_cast_fu_480_p1 + a_assign_3_cast8_fu_477_p1);

assign t_coeffs_d0 = tmp_55_fu_489_p4;

assign t_fu_320_p2 = ($signed(32'd4236238847) * $signed(tmp_reg_668));

assign tmp_172_i_fu_541_p2 = (w_coeffs_q0 + t_coeffs_q0);

assign tmp_26_cast_fu_560_p1 = i_1_reg_219;

assign tmp_42_fu_238_p3 = {{w_coeffs_offset}, {8'd0}};

assign tmp_42_i_cast_fu_614_p1 = $signed(tmp_42_i_fu_608_p2);

assign tmp_42_i_fu_608_p2 = (t_6_cast_fu_578_p1 - a_assign_2_cast_fu_592_p1);

assign tmp_43_fu_250_p3 = {{w_coeffs_offset}, {2'd0}};

assign tmp_44_fu_315_p2 = (tmp_i_cast_fu_311_p1 + tmp_45_cast_reg_633);

assign tmp_45_cast_fu_246_p1 = tmp_42_fu_238_p3;

assign tmp_45_fu_279_p4 = {{{w_coeffs_offset}, {1'd0}}, {i_i_reg_172}};

assign tmp_46_fu_288_p1 = tmp_45_fu_279_p4;

assign tmp_47_cast_fu_258_p1 = tmp_43_fu_250_p3;

assign tmp_47_fu_350_p4 = {{t_3_fu_344_p2[55:32]}};

assign tmp_48_cast_fu_334_p1 = tmp_44_reg_673;

assign tmp_48_fu_375_p2 = (tmp_cast_fu_371_p1 + tmp_47_cast_reg_640);

assign tmp_49_fu_388_p3 = {{i_reg_184}, {8'd0}};

assign tmp_50_fu_564_p2 = (tmp_26_cast_fu_560_p1 + tmp_45_cast_reg_633);

assign tmp_51_fu_582_p4 = {{w_coeffs_q0[31:23]}};

assign tmp_52_fu_420_p2 = (tmp_i3_cast_fu_416_p1 + tmp_53_cast_reg_691);

assign tmp_53_cast_fu_380_p3 = {{tmp_48_fu_375_p2}, {8'd0}};

assign tmp_53_fu_430_p2 = (tmp_i3_cast1_fu_412_p1 + tmp_55_cast_reg_696);

assign tmp_54_fu_454_p1 = a_assign_3_fu_448_p2[31:0];

assign tmp_55_cast_fu_396_p1 = tmp_49_fu_388_p3;

assign tmp_55_fu_489_p4 = {{t_8_fu_483_p2[55:32]}};

assign tmp_56_cast_fu_569_p1 = tmp_50_fu_564_p2;

assign tmp_56_fu_525_p2 = (tmp_45_cast_reg_633 + tmp_i2_cast_fu_521_p1);

assign tmp_59_cast_fu_425_p1 = tmp_52_fu_420_p2;

assign tmp_60_cast_fu_435_p1 = tmp_53_fu_430_p2;

assign tmp_61_cast_fu_530_p1 = tmp_56_fu_525_p2;
...
assign tmp_i1_fu_596_p3 = {{tmp_51_fu_582_p4}, {13'd0}};

assign tmp_i2_42_fu_516_p1 = i_i2_reg_208;

assign tmp_i2_cast_fu_521_p1 = i_i2_reg_208;

assign tmp_i2_fu_400_p2 = ((i_i1_reg_196 == 9'd256) ? 1'b1 : 1'b0);

assign tmp_i3_40_fu_504_p2 = ((i_i2_reg_208 == 9'd256) ? 1'b1 : 1'b0);
