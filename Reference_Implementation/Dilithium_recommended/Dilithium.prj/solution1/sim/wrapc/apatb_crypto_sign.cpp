...
char sk[3504])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *sm_pc_buffer = new sc_bv<8>[6101];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: sm
				{
					...
					// {
						// celement: sm(7, 0)
						// {
							sc_lv<8>* sm_lv0_0_6100_1 = new sc_lv<8>[6101];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: sm(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 6100; i_0 += 1)
							{
								...
								{
									sm_lv0_0_6100_1[hls_map_index].range(7, 0) = sc_bv<8>(sm_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: sm(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 6100; i_0 += 1)
							{
								...
								// output_type_conversion : (sm_lv0_0_6100_1[hls_map_index]).to_uint64()
								if (&(sm[0]) != NULL) // check the null address if the c port is array or others
								{
									sm[i_0] = (sm_lv0_0_6100_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<8>* sk_tvin_wrapc_buffer = new sc_bv<8>[3504];
		...
		tcl_file.set_num(3504, &tcl_file.sk_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<8>* sm_tvout_wrapc_buffer = new sc_bv<8>[6101];
