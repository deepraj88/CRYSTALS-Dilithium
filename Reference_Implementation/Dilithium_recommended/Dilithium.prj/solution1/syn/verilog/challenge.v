...
wire   [5:0] i_107_fu_367_p2;
reg   [5:0] i_107_reg_657;
wire    ap_CS_fsm_state2;
wire   [0:0] tmp_fu_361_p2;
wire   [2:0] i_108_fu_397_p2;
reg   [2:0] i_108_reg_670;
wire    ap_CS_fsm_state4;
wire   [10:0] p_sum1_cast_fu_417_p1;
reg   [10:0] p_sum1_cast_reg_675;
wire   [0:0] tmp_209_fu_391_p2;
wire   [7:0] i_21_fu_427_p2;
reg   [7:0] i_21_reg_683;
wire    ap_CS_fsm_state5;
wire   [0:0] tmp_i_fu_421_p2;
wire   [10:0] sum_i_fu_481_p2;
reg   [10:0] sum_i_reg_698;
wire   [3:0] i_109_fu_519_p2;
reg   [3:0] i_109_reg_706;
wire    ap_CS_fsm_state10;
wire   [0:0] tmp_212_fu_513_p2;
wire   [63:0] signs_1_fu_556_p2;
wire    ap_CS_fsm_state11;
wire   [8:0] i_110_fu_568_p2;
wire    ap_CS_fsm_state12;
wire   [0:0] tmp_220_fu_585_p2;
reg   [0:0] tmp_220_reg_732;
...
wire   [0:0] tmp_222_fu_606_p2;
wire   [0:0] tmp_226_fu_623_p2;
reg   [0:0] tmp_226_reg_755;
wire   [63:0] mask_2_fu_629_p2;
reg   [63:0] mask_2_reg_760;
wire   [8:0] i_111_fu_640_p2;
reg   [8:0] i_111_reg_765;
...
wire   [63:0] tmp_239_fu_453_p1;
wire   [63:0] tmp_241_fu_472_p1;
wire   [63:0] sum_i_cast_fu_509_p1;
wire   [63:0] tmp_213_fu_525_p1;
wire   [63:0] tmp_219_fu_574_p1;
wire   [63:0] tmp_221_fu_597_p1;
wire   [63:0] tmp_223_fu_612_p1;
wire   [63:0] tmp_224_fu_635_p1;
wire   [7:0] tmp_78_i_fu_502_p2;
wire   [22:0] tmp_318_cast_cast_ca_fu_646_p3;
wire   [6:0] sum1_fu_373_p3;
wire   [9:0] tmp_210_fu_403_p3;
wire   [9:0] p_sum1_fu_411_p2;
wire   [6:0] tmp_235_fu_433_p1;
wire   [10:0] tmp_238_fu_443_p4;
wire   [7:0] tmp_236_fu_437_p2;
wire   [7:0] tmp_76_i_fu_458_p2;
wire   [10:0] tmp_240_fu_464_p3;
wire   [10:0] tmp_79_i_cast_fu_477_p1;
wire   [3:0] tmp_242_fu_490_p1;
wire   [7:0] tmp_11_i_fu_494_p3;
wire   [7:0] tmp_237_fu_486_p1;
wire   [2:0] tmp_234_fu_534_p1;
wire   [5:0] tmp_215_fu_538_p3;
wire   [63:0] tmp_214_fu_530_p1;
wire   [63:0] tmp_216_fu_546_p1;
wire   [63:0] tmp_217_fu_550_p2;
wire   [8:0] b_cast_fu_602_p1;
wire   [63:0] tmp_225_fu_617_p2;
reg   [18:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((tmp_209_fu_391_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state8) | ((1'b1 == ap_CS_fsm_state14) & (tmp_220_fu_585_p2 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & (tmp_212_fu_513_p2 == 1'd1))) begin
        i_3_reg_275 <= 9'd0;
    end else if (((tmp_218_fu_562_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state12))) begin
        i_3_reg_275 <= i_110_fu_568_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_218_fu_562_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state12))) begin
        i_4_reg_286 <= 9'd196;
...
always @ (posedge ap_clk) begin
    ...
    end else if (((tmp_209_fu_391_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        i_i_reg_240 <= 8'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state17) & (tmp_222_fu_606_p2 == 1'd1))) begin
        pos_1_reg_322 <= pos_5_reg_736;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_220_fu_585_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state14))) begin
        pos_2_reg_333 <= pos_1_reg_322;
    end else if (((1'b0 == ap_block_state15_on_subcall_done) & (1'b1 == ap_CS_fsm_state15) & (tmp_220_reg_732 == 1'd1))) begin
        pos_2_reg_333 <= 32'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_222_fu_606_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state17))) begin
        c_coeffs_addr_1_reg_750 <= tmp_223_fu_612_p1;
...
always @ (posedge ap_clk) begin
    if (((tmp_209_fu_391_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state19)) begin
        ...
        c_coeffs_address0 = tmp_224_fu_635_p1;
    end else if ((1'b1 == ap_CS_fsm_state17)) begin
        c_coeffs_address0 = tmp_223_fu_612_p1;
    end else if ((1'b1 == ap_CS_fsm_state12)) begin
        c_coeffs_address0 = tmp_219_fu_574_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state19) | (1'b1 == ap_CS_fsm_state18) | ((tmp_218_fu_562_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state12)))) begin
        c_coeffs_we0 = 1'b1;
    end else begin
        c_coeffs_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        outbuf_address0 = tmp_221_fu_597_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        outbuf_address0 = tmp_213_fu_525_p1;
    end else if (((1'b1 == ap_CS_fsm_state9) | ((1'b1 == ap_CS_fsm_state15) & (tmp_220_reg_732 == 1'd1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | ((1'b1 == ap_CS_fsm_state15) & (tmp_220_reg_732 == 1'd1)))) begin
...
always @ (*) begin
    ap_block_state15_on_subcall_done = ((grp_keccak_squeezeblocks_2_fu_353_ap_done == 1'b0) & (tmp_220_reg_732 == 1'd1));
end
...
assign i_107_fu_367_p2 = (i_reg_216 + 6'd1);

assign i_108_fu_397_p2 = (i_1_reg_228 + 3'd1);

assign i_109_fu_519_p2 = (i_2_reg_251 + 4'd1);

assign i_110_fu_568_p2 = (i_3_reg_275 + 9'd1);

assign i_111_fu_640_p2 = (9'd1 + i_4_reg_286);

assign i_21_fu_427_p2 = (i_i_reg_240 + 8'd1);
...
assign p_sum1_fu_411_p2 = (tmp_210_fu_403_p3 | 10'd48);

assign pos_5_fu_591_p2 = (pos_2_reg_333 + 32'd1);

assign signs_1_fu_556_p2 = (tmp_217_fu_550_p2 | signs_reg_263);
...
assign tmp_11_i_fu_494_p3 = {{tmp_242_fu_490_p1}, {4'd0}};

assign tmp_209_fu_391_p2 = ((i_1_reg_228 == 3'd5) ? 1'b1 : 1'b0);

assign tmp_210_fu_403_p3 = {{i_1_reg_228}, {7'd0}};

assign tmp_212_fu_513_p2 = ((i_2_reg_251 == 4'd8) ? 1'b1 : 1'b0);

assign tmp_213_fu_525_p1 = i_2_reg_251;

assign tmp_214_fu_530_p1 = outbuf_q0;

assign tmp_215_fu_538_p3 = {{tmp_234_fu_534_p1}, {3'd0}};

assign tmp_216_fu_546_p1 = tmp_215_fu_538_p3;

assign tmp_217_fu_550_p2 = tmp_214_fu_530_p1 << tmp_216_fu_546_p1;

assign tmp_218_fu_562_p2 = ((i_3_reg_275 == 9'd256) ? 1'b1 : 1'b0);

assign tmp_219_fu_574_p1 = i_3_reg_275;

assign tmp_220_fu_585_p2 = ((pos_1_reg_322 > 32'd135) ? 1'b1 : 1'b0);

assign tmp_221_fu_597_p1 = pos_2_reg_333;

assign tmp_222_fu_606_p2 = ((b_cast_fu_602_p1 > i_4_reg_286) ? 1'b1 : 1'b0);

assign tmp_223_fu_612_p1 = outbuf_q0;

assign tmp_224_fu_635_p1 = i_4_reg_286;

assign tmp_225_fu_617_p2 = (signs_reg_263 & mask_reg_310);

assign tmp_226_fu_623_p2 = ((tmp_225_fu_617_p2 != 64'd0) ? 1'b1 : 1'b0);

assign tmp_234_fu_534_p1 = i_2_reg_251[2:0];

assign tmp_235_fu_433_p1 = i_i_reg_240[6:0];

assign tmp_236_fu_437_p2 = i_i_reg_240 << 8'd1;

assign tmp_237_fu_486_p1 = w1_vec_coeffs_q0[7:0];

assign tmp_238_fu_443_p4 = {{{i_1_reg_228}, {tmp_235_fu_433_p1}}, {1'd0}};

assign tmp_239_fu_453_p1 = tmp_238_fu_443_p4;

assign tmp_240_fu_464_p3 = {{i_1_reg_228}, {tmp_76_i_fu_458_p2}};

assign tmp_241_fu_472_p1 = tmp_240_fu_464_p3;

assign tmp_242_fu_490_p1 = w1_vec_coeffs_q1[3:0];

assign tmp_318_cast_cast_ca_fu_646_p3 = ((tmp_226_reg_755[0:0] === 1'b1) ? 23'd8380416 : 23'd1);

assign tmp_76_i_fu_458_p2 = (tmp_236_fu_437_p2 | 8'd1);

assign tmp_78_i_fu_502_p2 = (tmp_237_fu_486_p1 | tmp_11_i_fu_494_p3);
...
assign w1_vec_coeffs_address0 = tmp_239_fu_453_p1;

assign w1_vec_coeffs_address1 = tmp_241_fu_472_p1;
