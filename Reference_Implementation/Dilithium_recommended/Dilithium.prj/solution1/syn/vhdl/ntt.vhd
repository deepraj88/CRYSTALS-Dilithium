...
architecture behav of ntt is 
    ...
    signal tmp_105_cast_fu_136_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_105_cast_reg_370 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_116_fu_155_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_116_reg_385 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal tmp_118_fu_207_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_118_reg_414 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal tmp_123_fu_297_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_123_reg_462 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_fu_301_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_reg_467 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal t_25_fu_309_p2 : STD_LOGIC_VECTOR (54 downto 0);
    signal t_25_reg_472 : STD_LOGIC_VECTOR (54 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal tmp_97_reg_477 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal tmp_107_cast_fu_256_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_109_cast_fu_270_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_117_fu_159_p4 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_119_fu_183_p4 : STD_LOGIC_VECTOR (27 downto 0);
    ...
    signal tmp_121_fu_241_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_120_fu_237_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_122_fu_245_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_96_fu_251_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_124_fu_261_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_98_fu_265_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal a_assign_fu_292_p0 : STD_LOGIC_VECTOR (22 downto 0);
    signal a_assign_fu_292_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_25_fu_309_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal a_assign_cast1_fu_315_p1 : STD_LOGIC_VECTOR (55 downto 0);
    signal t_35_cast_fu_318_p1 : STD_LOGIC_VECTOR (55 downto 0);
    signal t_26_fu_321_p2 : STD_LOGIC_VECTOR (55 downto 0);
    signal tmp_90_fu_337_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_157_cast_fu_342_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_27_fu_353_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (12 downto 0);
    signal a_assign_fu_292_p10 : STD_LOGIC_VECTOR (54 downto 0);
    signal t_25_fu_309_p10 : STD_LOGIC_VECTOR (54 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state7)) then
                ...
                tmp_123_reg_462 <= tmp_123_fu_297_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_86_fu_232_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                ...
                p_addr11_reg_432 <= tmp_107_cast_fu_256_p1(11 - 1 downto 0);
                p_addr_reg_437 <= tmp_109_cast_fu_270_p1(11 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                ...
                tmp_118_reg_414 <= tmp_118_fu_207_p1;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                    tmp_105_cast_reg_370(10 downto 8) <= tmp_105_cast_fu_136_p1(10 downto 8);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                tmp_116_reg_385 <= tmp_116_fu_155_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then
                tmp_97_reg_477 <= t_26_fu_321_p2(55 downto 32);
            end if;
        end if;
    end process;
    tmp_105_cast_reg_370(7 downto 0) <= "00000000";
    tmp_105_cast_reg_370(11) <= '0';
    ...
    icmp_fu_169_p2 <= "1" when (tmp_117_fu_159_p4 = ap_const_lv23_0) else "0";
    ...
    len_1_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_119_fu_183_p4),29));
    len_cast_cast7_fu_145_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(len_reg_95),31));

    p_address0_assign_proc : process(p_addr11_reg_432, ap_CS_fsm_state5, p_addr_reg_437, ap_CS_fsm_state10, ap_CS_fsm_state13, tmp_107_cast_fu_256_p1, ap_CS_fsm_state11, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            ...
            p_address0 <= tmp_107_cast_fu_256_p1(11 - 1 downto 0);
        else 
    ...
    start_fu_217_p3 <= 
        tmp_116_reg_385 when (tmp_85_fu_211_p2(0) = '1') else 
        tmp_118_fu_207_p1;
    t_25_fu_309_p1 <= t_25_fu_309_p10(32 - 1 downto 0);
    t_25_fu_309_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_reg_467),55));
    t_25_fu_309_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_const_lv55_7FE001) * unsigned(t_25_fu_309_p1), 55));
    t_26_fu_321_p2 <= std_logic_vector(unsigned(a_assign_cast1_fu_315_p1) + unsigned(t_35_cast_fu_318_p1));
    t_27_fu_353_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_97_reg_477),32));
    t_35_cast_fu_318_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_25_reg_472),56));
    t_fu_301_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(ap_const_lv32_FC7FDFFF) * signed(tmp_123_reg_462))), 32));
    tmp_105_cast_fu_136_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_128_p3),12));
    tmp_107_cast_fu_256_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_96_fu_251_p2),64));
    tmp_109_cast_fu_270_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_98_fu_265_p2),64));
    tmp_116_fu_155_p1 <= j_reg_107(30 - 1 downto 0);
    tmp_117_fu_159_p4 <= j_reg_107(30 downto 8);
    tmp_118_fu_207_p1 <= tmp_84_fu_202_p2(30 - 1 downto 0);
    tmp_119_fu_183_p4 <= len_reg_95(28 downto 1);
    tmp_120_fu_237_p1 <= j5_reg_119(12 - 1 downto 0);
    tmp_121_fu_241_p1 <= len_reg_95(12 - 1 downto 0);
    tmp_122_fu_245_p2 <= std_logic_vector(unsigned(tmp_121_fu_241_p1) + unsigned(tmp_120_fu_237_p1));
    tmp_123_fu_297_p1 <= a_assign_fu_292_p2(32 - 1 downto 0);
    tmp_124_fu_261_p1 <= j5_reg_119(12 - 1 downto 0);
    ...
    tmp_86_fu_232_p2 <= "1" when (unsigned(j5_reg_119) < unsigned(tmp_118_reg_414)) else "0";
    tmp_90_fu_337_p2 <= std_logic_vector(signed(ap_const_lv24_FFC002) - signed(tmp_97_reg_477));
    tmp_91_fu_346_p2 <= std_logic_vector(unsigned(tmp_157_cast_fu_342_p1) + unsigned(p_q0));
    tmp_92_fu_356_p2 <= std_logic_vector(unsigned(t_27_fu_353_p1) + unsigned(p_q0));
    tmp_93_fu_281_p2 <= std_logic_vector(unsigned(len_cast_cast7_reg_376) + unsigned(start_cast_reg_419));
    tmp_96_fu_251_p2 <= std_logic_vector(unsigned(tmp_105_cast_reg_370) + unsigned(tmp_122_fu_245_p2));
    tmp_98_fu_265_p2 <= std_logic_vector(unsigned(tmp_105_cast_reg_370) + unsigned(tmp_124_fu_261_p1));
