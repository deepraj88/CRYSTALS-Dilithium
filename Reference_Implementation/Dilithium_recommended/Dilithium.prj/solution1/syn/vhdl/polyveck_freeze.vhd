...
architecture behav of polyveck_freeze is 
    ...
    signal i_24_fu_89_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_24_reg_219 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_71_cast_fu_103_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_71_cast_reg_224 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_fu_83_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_25_fu_113_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_25_reg_232 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_fu_83_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    tmp_71_cast_reg_224(10 downto 8) <= tmp_71_cast_fu_103_p1(10 downto 8);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_i_fu_107_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                v_vec_coeffs_addr_reg_237 <= tmp_72_cast_fu_128_p1(11 - 1 downto 0);
            end if;
        end if;
    end process;
    tmp_71_cast_reg_224(7 downto 0) <= "00000000";
    tmp_71_cast_reg_224(11) <= '0';
    ...
    a_assign_13_cast_fu_151_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_70_fu_141_p4),24));
    ...
    i_24_fu_89_p2 <= std_logic_vector(unsigned(i_reg_61) + unsigned(ap_const_lv3_1));
    i_25_fu_113_p2 <= std_logic_vector(unsigned(i_i_reg_72) + unsigned(ap_const_lv9_1));
    ...
    tmp12_fu_181_p3 <= (ap_const_lv10_3FE & tmp_71_fu_175_p2);
        tmp_42_i_i_i_cast_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_42_i_i_i_fu_165_p2),32));

    tmp_42_i_i_i_fu_165_p2 <= std_logic_vector(unsigned(t_cast_fu_137_p1) - unsigned(a_assign_13_cast_fu_151_p1));
    tmp_69_fu_123_p2 <= std_logic_vector(unsigned(tmp_i_cast_fu_119_p1) + unsigned(tmp_71_cast_reg_224));
    tmp_70_fu_141_p4 <= v_vec_coeffs_q0(31 downto 23);
    tmp_71_cast_fu_103_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_95_p3),12));
    tmp_71_fu_175_p2 <= (tmp_i_i_i_fu_155_p4 or ap_const_lv22_1FFF);
    tmp_72_cast_fu_128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_69_fu_123_p2),64));
    tmp_72_fu_195_p3 <= a_assign_s_reg_242(31 downto 31);
    ...
    tmp_i_i_cast_cast_fu_202_p3 <= 
        ap_const_lv32_7FE001 when (tmp_72_fu_195_p3(0) = '1') else 
        ap_const_lv32_0;
    tmp_i_i_i_fu_155_p4 <= v_vec_coeffs_q0(31 downto 10);
    tmp_s_fu_95_p3 <= (i_reg_61 & ap_const_lv8_0);

    v_vec_coeffs_address0_assign_proc : process(ap_CS_fsm_state3, v_vec_coeffs_addr_reg_237, ap_CS_fsm_state5, tmp_72_cast_fu_128_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            v_vec_coeffs_address0 <= v_vec_coeffs_addr_reg_237;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            v_vec_coeffs_address0 <= tmp_72_cast_fu_128_p1(11 - 1 downto 0);
        else 
