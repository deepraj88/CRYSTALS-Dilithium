...
wire   [5:0] i_63_fu_246_p2;
reg   [5:0] i_63_reg_413;
wire    ap_CS_fsm_state2;
wire   [63:0] tmp_s_fu_252_p1;
reg   [63:0] tmp_s_reg_418;
wire   [0:0] tmp_fu_240_p2;
wire   [2:0] i_64_fu_263_p2;
reg   [2:0] i_64_reg_436;
wire    ap_CS_fsm_state4;
wire   [5:0] tmp_175_cast_fu_277_p1;
reg   [5:0] tmp_175_cast_reg_441;
wire   [0:0] exitcond1_fu_257_p2;
wire   [2:0] j_8_fu_287_p2;
reg   [2:0] j_8_reg_449;
wire    ap_CS_fsm_state5;
wire   [5:0] tmp_175_fu_316_p2;
reg   [5:0] tmp_175_reg_454;
wire   [0:0] exitcond_fu_281_p2;
wire   [13:0] tmp_178_cast_fu_321_p3;
reg   [13:0] tmp_178_cast_reg_459;
...
wire   [0:0] tmp_171_fu_383_p2;
reg    grp_keccak_squeezeblocks_3_fu_226_ap_start_reg;
wire    ap_CS_fsm_state8;
reg    grp_keccak_absorb_3_fu_234_ap_start_reg;
wire    ap_CS_fsm_state6;
wire    ap_CS_fsm_state7;
wire   [63:0] tmp_168_fu_336_p1;
wire   [63:0] tmp_169_fu_353_p1;
wire   [63:0] tmp_170_fu_364_p1;
wire   [63:0] tmp_179_cast_fu_405_p1;
wire   [7:0] tmp_256_cast_fu_307_p1;
wire   [22:0] tmp_34_fu_373_p4;
wire   [4:0] tmp_173_fu_269_p3;
wire   [1:0] tmp_174_fu_293_p1;
wire   [5:0] tmp_165_fu_297_p4;
wire   [5:0] tmp_166_cast_fu_312_p1;
wire   [31:0] pos_2_fu_341_p2;
wire   [31:0] pos_3_fu_347_p2;
wire   [6:0] tmp_177_fu_369_p1;
wire   [13:0] tmp_172_cast_fu_396_p1;
wire   [13:0] tmp_178_fu_400_p2;
reg   [11:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_176_fu_328_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_257_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        tmp_175_cast_reg_441[4 : 2] <= tmp_175_cast_fu_277_p1[4 : 2];
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_keccak_squeezeblocks_3_fu_226_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        tmp_178_cast_reg_459[13 : 8] <= tmp_178_cast_fu_321_p3[13 : 8];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        if ((tmp_171_fu_383_p2 == 1'd0)) begin
            ap_phi_mux_ctr_be_phi_fu_218_p4 = ctr_reg_202;
        end else if ((tmp_171_fu_383_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((tmp_171_fu_383_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        output_assign_address0 = tmp_169_fu_353_p1;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        output_assign_address0 = tmp_168_fu_336_p1;
...
assign i_63_fu_246_p2 = (i_reg_156 + 6'd1);

assign i_64_fu_263_p2 = (i_1_reg_167 + 3'd1);

assign j_8_fu_287_p2 = (j_reg_179 + 3'd1);

assign mat_vec_coeffs_address0 = tmp_179_cast_fu_405_p1;

assign mat_vec_coeffs_d0 = tmp_34_fu_373_p4;

assign output_assign_address1 = tmp_170_fu_364_p1;
...
assign tmp_165_fu_297_p4 = {{{tmp_174_fu_293_p1}, {1'd0}}, {i_1_reg_167}};

assign tmp_166_cast_fu_312_p1 = j_reg_179;

assign tmp_168_fu_336_p1 = pos_reg_190;

assign tmp_169_fu_353_p1 = pos_2_fu_341_p2;

assign tmp_170_fu_364_p1 = pos_3_fu_347_p2;

assign tmp_171_fu_383_p2 = ((tmp_34_fu_373_p4 < 23'd8380417) ? 1'b1 : 1'b0);

assign tmp_172_cast_fu_396_p1 = ctr_reg_202;

assign tmp_173_fu_269_p3 = {{i_1_reg_167}, {2'd0}};

assign tmp_174_fu_293_p1 = j_reg_179[1:0];

assign tmp_175_cast_fu_277_p1 = tmp_173_fu_269_p3;

assign tmp_175_fu_316_p2 = (tmp_175_cast_reg_441 + tmp_166_cast_fu_312_p1);

assign tmp_176_fu_328_p3 = ctr_reg_202[32'd8];

assign tmp_177_fu_369_p1 = output_assign_q1[6:0];

assign tmp_178_cast_fu_321_p3 = {{tmp_175_reg_454}, {8'd0}};

assign tmp_178_fu_400_p2 = (tmp_178_cast_reg_459 + tmp_172_cast_fu_396_p1);

assign tmp_179_cast_fu_405_p1 = tmp_178_fu_400_p2;

assign tmp_256_cast_fu_307_p1 = tmp_165_fu_297_p4;

assign tmp_34_fu_373_p4 = {{{tmp_177_fu_369_p1}, {output_assign_q0}}, {output_assign_load_reg_472}};
...
always @ (posedge ap_clk) begin
    ...
    tmp_175_cast_reg_441[1:0] <= 2'b00;
    tmp_175_cast_reg_441[5] <= 1'b0;
    tmp_178_cast_reg_459[7:0] <= 8'b00000000;
end
