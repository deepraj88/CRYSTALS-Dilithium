...
architecture behav of expand_mat is 
    ...
    signal i_63_fu_246_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_63_reg_413 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal i_64_fu_263_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_64_reg_436 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal tmp_175_cast_fu_277_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_175_cast_reg_441 : STD_LOGIC_VECTOR (5 downto 0);
    signal exitcond1_fu_257_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_8_fu_287_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_8_reg_449 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal tmp_175_fu_316_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_175_reg_454 : STD_LOGIC_VECTOR (5 downto 0);
    signal exitcond_fu_281_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_178_cast_fu_321_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_178_cast_reg_459 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal tmp_176_fu_328_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal pos_4_fu_358_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal pos_4_reg_482 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_keccak_absorb_3_fu_234_ap_start : STD_LOGIC;
    signal grp_keccak_absorb_3_fu_234_ap_done : STD_LOGIC;
    signal grp_keccak_absorb_3_fu_234_ap_idle : STD_LOGIC;
    signal grp_keccak_absorb_3_fu_234_ap_ready : STD_LOGIC;
    signal grp_keccak_absorb_3_fu_234_s_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_keccak_absorb_3_fu_234_s_ce0 : STD_LOGIC;
    signal grp_keccak_absorb_3_fu_234_s_we0 : STD_LOGIC;
    signal grp_keccak_absorb_3_fu_234_s_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_keccak_absorb_3_fu_234_m_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_keccak_absorb_3_fu_234_m_ce0 : STD_LOGIC;
    ...
    signal ctr_6_fu_389_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_171_fu_383_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_keccak_squeezeblocks_3_fu_226_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal grp_keccak_absorb_3_fu_234_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal tmp_168_fu_336_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_169_fu_353_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_170_fu_364_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_179_cast_fu_405_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_256_cast_fu_307_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_34_fu_373_p4 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_173_fu_269_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_174_fu_293_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_165_fu_297_p4 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_166_cast_fu_312_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal pos_2_fu_341_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal pos_3_fu_347_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_177_fu_369_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_172_cast_fu_396_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal tmp_178_fu_400_p2 : STD_LOGIC_VECTOR (13 downto 0);
...
begin
    ...
    grp_keccak_absorb_3_fu_234 : component keccak_absorb_3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_keccak_absorb_3_fu_234_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_keccak_absorb_3_fu_234_ap_ready = ap_const_logic_1)) then 
                    grp_keccak_absorb_3_fu_234_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_176_fu_328_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_fu_257_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    tmp_175_cast_reg_441(4 downto 2) <= tmp_175_cast_fu_277_p1(4 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_281_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                tmp_175_reg_454 <= tmp_175_fu_316_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_keccak_squeezeblocks_3_fu_226_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
                    tmp_178_cast_reg_459(13 downto 8) <= tmp_178_cast_fu_321_p3(13 downto 8);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_175_cast_reg_441(1 downto 0) <= "00";
    tmp_175_cast_reg_441(5) <= '0';
    tmp_178_cast_reg_459(7 downto 0) <= "00000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, tmp_fu_240_p2, ap_CS_fsm_state4, exitcond1_fu_257_p2, ap_CS_fsm_state5, exitcond_fu_281_p2, ap_CS_fsm_state9, grp_keccak_squeezeblocks_3_fu_226_ap_done, ap_CS_fsm_state10, tmp_176_fu_328_p3, grp_keccak_absorb_3_fu_234_ap_done, ap_CS_fsm_state7)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state7 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state7) and (grp_keccak_absorb_3_fu_234_ap_done = ap_const_logic_1))) then
    ...
    ap_phi_mux_ctr_be_phi_fu_218_p4_assign_proc : process(ap_CS_fsm_state12, ctr_reg_202, ctr_6_fu_389_p2, tmp_171_fu_383_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
            if ((tmp_171_fu_383_p2 = ap_const_lv1_0)) then 
                ap_phi_mux_ctr_be_phi_fu_218_p4 <= ctr_reg_202;
            elsif ((tmp_171_fu_383_p2 = ap_const_lv1_1)) then 
    ...
    ctr_6_fu_389_p2 <= std_logic_vector(unsigned(ctr_reg_202) + unsigned(ap_const_lv9_1));
    exitcond1_fu_257_p2 <= "1" when (i_1_reg_167 = ap_const_lv3_5) else "0";
    exitcond_fu_281_p2 <= "1" when (j_reg_179 = ap_const_lv3_4) else "0";
    grp_keccak_absorb_3_fu_234_ap_start <= grp_keccak_absorb_3_fu_234_ap_start_reg;
    grp_keccak_squeezeblocks_3_fu_226_ap_start <= grp_keccak_squeezeblocks_3_fu_226_ap_start_reg;
    i_63_fu_246_p2 <= std_logic_vector(unsigned(i_reg_156) + unsigned(ap_const_lv6_1));
    i_64_fu_263_p2 <= std_logic_vector(unsigned(i_1_reg_167) + unsigned(ap_const_lv3_1));

    inbuf_address0_assign_proc : process(tmp_s_reg_418, ap_CS_fsm_state5, grp_keccak_absorb_3_fu_234_m_address0, ap_CS_fsm_state3, ap_CS_fsm_state7)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    inbuf_ce0_assign_proc : process(ap_CS_fsm_state5, grp_keccak_absorb_3_fu_234_m_ce0, ap_CS_fsm_state3, ap_CS_fsm_state7)
    begin
    ...
    inbuf_d0_assign_proc : process(rho_q0, ap_CS_fsm_state5, ap_CS_fsm_state3, tmp_256_cast_fu_307_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    j_8_fu_287_p2 <= std_logic_vector(unsigned(j_reg_179) + unsigned(ap_const_lv3_1));
    mat_vec_coeffs_address0 <= tmp_179_cast_fu_405_p1(13 - 1 downto 0);
    ...
    mat_vec_coeffs_d0 <= tmp_34_fu_373_p4;

    mat_vec_coeffs_we0_assign_proc : process(ap_CS_fsm_state12, tmp_171_fu_383_p2)
    begin
        if (((tmp_171_fu_383_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state12))) then 
    ...
    output_assign_address0_assign_proc : process(ap_CS_fsm_state9, ap_CS_fsm_state10, ap_CS_fsm_state11, grp_keccak_squeezeblocks_3_fu_226_h_address0, tmp_168_fu_336_p1, tmp_169_fu_353_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            output_assign_address0 <= tmp_169_fu_353_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            output_assign_address0 <= tmp_168_fu_336_p1(10 - 1 downto 0);
    ...
    output_assign_address1 <= tmp_170_fu_364_p1(10 - 1 downto 0);
    ...
    pos_2_fu_341_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(pos_reg_190));
    pos_3_fu_347_p2 <= std_logic_vector(unsigned(ap_const_lv32_2) + unsigned(pos_reg_190));
    pos_4_fu_358_p2 <= std_logic_vector(unsigned(ap_const_lv32_3) + unsigned(pos_reg_190));
    rho_address0 <= tmp_s_fu_252_p1(7 - 1 downto 0);
    ...
    s_address0_assign_proc : process(ap_CS_fsm_state9, grp_keccak_squeezeblocks_3_fu_226_s_address0, grp_keccak_absorb_3_fu_234_s_address0, ap_CS_fsm_state7)
    begin
    ...
    s_ce0_assign_proc : process(ap_CS_fsm_state9, grp_keccak_squeezeblocks_3_fu_226_s_ce0, grp_keccak_absorb_3_fu_234_s_ce0, ap_CS_fsm_state7)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            s_ce0 <= grp_keccak_absorb_3_fu_234_s_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    s_d0_assign_proc : process(ap_CS_fsm_state9, grp_keccak_squeezeblocks_3_fu_226_s_d0, grp_keccak_absorb_3_fu_234_s_d0, ap_CS_fsm_state7)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            s_d0 <= grp_keccak_absorb_3_fu_234_s_d0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    s_we0_assign_proc : process(ap_CS_fsm_state9, grp_keccak_squeezeblocks_3_fu_226_s_we0, grp_keccak_absorb_3_fu_234_s_we0, ap_CS_fsm_state7)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            s_we0 <= grp_keccak_absorb_3_fu_234_s_we0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    tmp_165_fu_297_p4 <= ((tmp_174_fu_293_p1 & ap_const_lv1_0) & i_1_reg_167);
    tmp_166_cast_fu_312_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_reg_179),6));
    tmp_168_fu_336_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(pos_reg_190),64));
    tmp_169_fu_353_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(pos_2_fu_341_p2),64));
    tmp_170_fu_364_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(pos_3_fu_347_p2),64));
    tmp_171_fu_383_p2 <= "1" when (unsigned(tmp_34_fu_373_p4) < unsigned(ap_const_lv23_7FE001)) else "0";
    tmp_172_cast_fu_396_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ctr_reg_202),14));
    tmp_173_fu_269_p3 <= (i_1_reg_167 & ap_const_lv2_0);
    tmp_174_fu_293_p1 <= j_reg_179(2 - 1 downto 0);
    tmp_175_cast_fu_277_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_173_fu_269_p3),6));
    tmp_175_fu_316_p2 <= std_logic_vector(unsigned(tmp_175_cast_reg_441) + unsigned(tmp_166_cast_fu_312_p1));
    tmp_176_fu_328_p3 <= ctr_reg_202(8 downto 8);
    tmp_177_fu_369_p1 <= output_assign_q1(7 - 1 downto 0);
    tmp_178_cast_fu_321_p3 <= (tmp_175_reg_454 & ap_const_lv8_0);
    tmp_178_fu_400_p2 <= std_logic_vector(unsigned(tmp_178_cast_reg_459) + unsigned(tmp_172_cast_fu_396_p1));
    tmp_179_cast_fu_405_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_178_fu_400_p2),64));
    tmp_256_cast_fu_307_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_165_fu_297_p4),8));
    tmp_34_fu_373_p4 <= ((tmp_177_fu_369_p1 & output_assign_q0) & output_assign_load_reg_472);
