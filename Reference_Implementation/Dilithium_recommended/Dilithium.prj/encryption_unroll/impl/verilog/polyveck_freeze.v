...
wire   [2:0] i_23_fu_89_p2;
reg   [2:0] i_23_reg_219;
wire    ap_CS_fsm_state2;
wire   [11:0] tmp_579_cast_fu_103_p1;
reg   [11:0] tmp_579_cast_reg_224;
wire   [0:0] tmp_fu_83_p2;
wire   [8:0] i_24_fu_113_p2;
reg   [8:0] i_24_reg_232;
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_83_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_579_cast_reg_224[10 : 8] <= tmp_579_cast_fu_103_p1[10 : 8];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_i_fu_107_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        v_vec_coeffs_addr_reg_237 <= tmp_580_cast_fu_128_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        v_vec_coeffs_address0 = tmp_580_cast_fu_128_p1;
    end else begin
...
assign a_assign_11_cast_fu_151_p1 = tmp_579_fu_141_p4;
...
assign i_23_fu_89_p2 = (i_reg_61 + 3'd1);

assign i_24_fu_113_p2 = (i_i_reg_72 + 9'd1);

assign t_cast_fu_137_p1 = t_fu_133_p1;

assign t_fu_133_p1 = v_vec_coeffs_q0[22:0];

assign tmp12_fu_181_p3 = {{10'd1022}, {tmp_580_fu_175_p2}};

assign tmp_42_i_i_i_cast_fu_171_p1 = $signed(tmp_42_i_i_i_fu_165_p2);

assign tmp_42_i_i_i_fu_165_p2 = (t_cast_fu_137_p1 - a_assign_11_cast_fu_151_p1);

assign tmp_578_fu_123_p2 = (tmp_i_cast_fu_119_p1 + tmp_579_cast_reg_224);

assign tmp_579_cast_fu_103_p1 = tmp_s_fu_95_p3;

assign tmp_579_fu_141_p4 = {{v_vec_coeffs_q0[31:23]}};

assign tmp_580_cast_fu_128_p1 = tmp_578_fu_123_p2;

assign tmp_580_fu_175_p2 = (tmp_i_i_i_fu_155_p4 | 22'd8191);

assign tmp_581_fu_195_p3 = a_assign_s_reg_242[32'd31];
...
assign tmp_i_i_cast_cast_fu_202_p3 = ((tmp_581_fu_195_p3[0:0] === 1'b1) ? 32'd8380417 : 32'd0);
...
always @ (posedge ap_clk) begin
    tmp_579_cast_reg_224[7:0] <= 8'b00000000;
    tmp_579_cast_reg_224[11] <= 1'b0;
end
