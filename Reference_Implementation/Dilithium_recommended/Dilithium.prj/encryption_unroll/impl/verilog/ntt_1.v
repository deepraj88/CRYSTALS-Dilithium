...
reg    zetas_ce0;
wire   [22:0] zetas_q0;
wire   [11:0] tmp_607_cast_fu_136_p1;
reg   [11:0] tmp_607_cast_reg_370;
wire   [30:0] len_cast_cast7_fu_145_p1;
reg   [30:0] len_cast_cast7_reg_376;
wire    ap_CS_fsm_state2;
wire   [29:0] tmp_616_fu_155_p1;
reg   [29:0] tmp_616_reg_385;
...
wire   [29:0] tmp_618_fu_207_p1;
reg   [29:0] tmp_618_reg_414;
...
wire  signed [31:0] tmp_623_fu_297_p1;
reg  signed [31:0] tmp_623_reg_462;
wire   [31:0] t_fu_301_p2;
reg   [31:0] t_reg_467;
wire    ap_CS_fsm_state8;
wire   [54:0] t_21_fu_309_p2;
reg   [54:0] t_21_reg_472;
wire    ap_CS_fsm_state9;
reg   [23:0] tmp_602_reg_477;
...
wire   [63:0] tmp_609_cast_fu_256_p1;
wire   [63:0] tmp_611_cast_fu_270_p1;
reg   [31:0] k_fu_52;
...
wire   [22:0] tmp_617_fu_159_p4;
wire   [27:0] tmp_619_fu_183_p4;
wire   [30:0] tmp_73_fu_202_p2;
wire   [0:0] tmp_74_fu_211_p2;
wire   [29:0] start_fu_217_p3;
wire   [11:0] tmp_621_fu_241_p1;
wire   [11:0] tmp_620_fu_237_p1;
wire   [11:0] tmp_622_fu_245_p2;
wire   [11:0] tmp_601_fu_251_p2;
wire   [11:0] tmp_624_fu_261_p1;
wire   [11:0] tmp_603_fu_265_p2;
wire   [22:0] a_assign_fu_292_p0;
wire   [31:0] a_assign_fu_292_p1;
wire   [31:0] t_21_fu_309_p1;
wire   [55:0] a_assign_cast1_fu_315_p1;
wire   [55:0] t_30_cast_fu_318_p1;
wire   [55:0] t_22_fu_321_p2;
wire   [23:0] tmp_79_fu_337_p2;
wire   [31:0] tmp_143_cast_fu_342_p1;
wire   [31:0] t_23_fu_353_p1;
reg   [12:0] ap_NS_fsm;
wire   [54:0] a_assign_fu_292_p10;
wire   [54:0] t_21_fu_309_p10;
...
always @ (posedge ap_clk) begin
    if (((tmp_75_fu_232_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        ...
        p_addr11_reg_432 <= tmp_609_cast_fu_256_p1;
        p_addr_reg_437 <= tmp_611_cast_fu_270_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        tmp_602_reg_477 <= {{t_22_fu_321_p2[55:32]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        tmp_607_cast_reg_370[10 : 8] <= tmp_607_cast_fu_136_p1[10 : 8];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ...
        p_address0 = tmp_609_cast_fu_256_p1;
    end else begin
        p_address0 = 'bx;
    end
end
...
assign icmp_fu_169_p2 = ((tmp_617_fu_159_p4 == 23'd0) ? 1'b1 : 1'b0);

assign j_5_fu_275_p2 = (30'd1 + j5_reg_119);

assign k_4_fu_197_p2 = (32'd1 + k_fu_52);

assign len_1_fu_193_p1 = tmp_619_fu_183_p4;

assign len_cast_cast7_fu_145_p1 = len_reg_95;

assign start_cast_fu_224_p1 = start_fu_217_p3;

assign start_fu_217_p3 = ((tmp_74_fu_211_p2[0:0] === 1'b1) ? tmp_616_reg_385 : tmp_618_fu_207_p1);

assign t_21_fu_309_p1 = t_21_fu_309_p10;

assign t_21_fu_309_p10 = t_reg_467;

assign t_21_fu_309_p2 = (55'd8380417 * t_21_fu_309_p1);

assign t_22_fu_321_p2 = (a_assign_cast1_fu_315_p1 + t_30_cast_fu_318_p1);

assign t_23_fu_353_p1 = tmp_602_reg_477;

assign t_30_cast_fu_318_p1 = t_21_reg_472;

assign t_fu_301_p2 = ($signed(32'd4236238847) * $signed(tmp_623_reg_462));

assign tmp_136_cast_fu_228_p1 = zetas_q0;

assign tmp_143_cast_fu_342_p1 = tmp_79_fu_337_p2;

assign tmp_601_fu_251_p2 = (tmp_607_cast_reg_370 + tmp_622_fu_245_p2);

assign tmp_603_fu_265_p2 = (tmp_607_cast_reg_370 + tmp_624_fu_261_p1);

assign tmp_607_cast_fu_136_p1 = tmp_s_fu_128_p3;

assign tmp_609_cast_fu_256_p1 = tmp_601_fu_251_p2;

assign tmp_611_cast_fu_270_p1 = tmp_603_fu_265_p2;

assign tmp_616_fu_155_p1 = j_reg_107[29:0];

assign tmp_617_fu_159_p4 = {{j_reg_107[30:8]}};

assign tmp_618_fu_207_p1 = tmp_73_fu_202_p2[29:0];

assign tmp_619_fu_183_p4 = {{len_reg_95[28:1]}};

assign tmp_620_fu_237_p1 = j5_reg_119[11:0];

assign tmp_621_fu_241_p1 = len_reg_95[11:0];

assign tmp_622_fu_245_p2 = (tmp_621_fu_241_p1 + tmp_620_fu_237_p1);

assign tmp_623_fu_297_p1 = a_assign_fu_292_p2[31:0];

assign tmp_624_fu_261_p1 = j5_reg_119[11:0];
...
assign tmp_75_fu_232_p2 = ((j5_reg_119 < tmp_618_reg_414) ? 1'b1 : 1'b0);

assign tmp_79_fu_337_p2 = ($signed(24'd16760834) - $signed(tmp_602_reg_477));

assign tmp_80_fu_346_p2 = (tmp_143_cast_fu_342_p1 + p_q0);

assign tmp_81_fu_356_p2 = (t_23_fu_353_p1 + p_q0);
...
always @ (posedge ap_clk) begin
    tmp_607_cast_reg_370[7:0] <= 8'b00000000;
    tmp_607_cast_reg_370[11] <= 1'b0;
