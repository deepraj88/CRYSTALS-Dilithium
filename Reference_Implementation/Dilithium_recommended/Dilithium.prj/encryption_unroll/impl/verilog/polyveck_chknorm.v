...
wire   [2:0] i_26_fu_117_p2;
reg   [2:0] i_26_reg_231;
wire    ap_CS_fsm_state2;
wire   [11:0] tmp_589_cast_fu_131_p1;
reg   [11:0] tmp_589_cast_reg_236;
wire   [0:0] tmp_fu_111_p2;
wire   [0:0] tmp_i_fu_135_p2;
reg   [0:0] tmp_i_reg_241;
wire    ap_CS_fsm_state3;
wire   [8:0] i_2_fu_141_p2;
reg   [8:0] i_2_reg_245;
...
wire   [63:0] tmp_590_cast_fu_156_p1;
wire   [10:0] tmp_s_fu_123_p3;
wire   [11:0] tmp_i_cast_fu_147_p1;
wire   [11:0] tmp_585_fu_151_p2;
wire   [31:0] t_fu_161_p2;
wire   [0:0] tmp_586_fu_166_p3;
wire   [31:0] tmp_170_i_fu_174_p3;
wire   [31:0] t_16_fu_182_p2;
wire   [31:0] t_17_fu_188_p2;
wire   [0:0] tmp_587_fu_200_p1;
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_111_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_589_cast_reg_236[10 : 8] <= tmp_589_cast_fu_131_p1[10 : 8];
    end
end
...
assign i_26_fu_117_p2 = (i_reg_65 + 3'd1);

assign i_2_fu_141_p2 = (i_i_reg_88 + 9'd1);

assign ret_1_fu_220_p3 = {{tmp_37_fu_210_p4}, {tmp_36_fu_204_p2}};

assign t_16_fu_182_p2 = (tmp_170_i_fu_174_p3 ^ t_fu_161_p2);

assign t_17_fu_188_p2 = (32'd4190208 - t_16_fu_182_p2);

assign t_fu_161_p2 = (32'd4190208 - v_vec_coeffs_load_reg_255);

assign tmp_170_i_fu_174_p3 = ((tmp_586_fu_166_p3[0:0] === 1'b1) ? 32'd4294967295 : 32'd0);

assign tmp_171_i_fu_194_p2 = ((t_17_fu_188_p2 < 32'd261613) ? 1'b1 : 1'b0);

assign tmp_36_fu_204_p2 = (tmp_587_fu_200_p1 | ap_phi_mux_p_0_i_phi_fu_103_p4);

assign tmp_37_fu_210_p4 = {{ret_reg_76[31:1]}};

assign tmp_585_fu_151_p2 = (tmp_589_cast_reg_236 + tmp_i_cast_fu_147_p1);

assign tmp_586_fu_166_p3 = t_fu_161_p2[32'd31];

assign tmp_587_fu_200_p1 = ret_reg_76[0:0];

assign tmp_589_cast_fu_131_p1 = tmp_s_fu_123_p3;

assign tmp_590_cast_fu_156_p1 = tmp_585_fu_151_p2;
...
assign v_vec_coeffs_address0 = tmp_590_cast_fu_156_p1;

always @ (posedge ap_clk) begin
    tmp_589_cast_reg_236[7:0] <= 8'b00000000;
    tmp_589_cast_reg_236[11] <= 1'b0;
end
