...
wire   [2:0] i_25_fu_135_p2;
reg   [2:0] i_25_reg_361;
wire    ap_CS_fsm_state2;
wire   [11:0] tmp_584_cast_fu_149_p1;
reg   [11:0] tmp_584_cast_reg_366;
wire   [0:0] tmp_fu_129_p2;
wire   [8:0] j_2_fu_159_p2;
reg   [8:0] j_2_reg_374;
wire    ap_CS_fsm_state3;
wire   [63:0] tmp_585_cast_fu_174_p1;
reg   [63:0] tmp_585_cast_reg_379;
wire   [0:0] tmp_29_fu_153_p2;
reg   [31:0] v_vec_coeffs_load_reg_390;
wire    ap_CS_fsm_state4;
wire  signed [23:0] t_15_fu_241_p2;
reg  signed [23:0] t_15_reg_395;
wire   [3:0] a_assign_3_fu_319_p2;
reg   [3:0] a_assign_3_reg_401;
...
wire   [11:0] tmp_581_fu_169_p2;
wire   [18:0] t_fu_179_p1;
wire   [12:0] tmp_582_fu_187_p4;
...
wire   [23:0] t_14_fu_219_p2;
wire   [0:0] tmp_583_fu_225_p3;
wire   [23:0] tmp_285_i_cast_cast_fu_233_p3;
wire   [31:0] t_1_i_fu_250_p2;
wire  signed [31:0] t_22_cast_fu_247_p1;
wire   [31:0] a_assign_s_fu_255_p2;
wire   [12:0] tmp_584_fu_267_p4;
wire   [31:0] u_fu_261_p2;
wire   [0:0] tmp_585_fu_281_p3;
...
wire   [13:0] a_assign_2_fu_313_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        tmp_287_i_reg_406 <= {{a_assign_2_fu_313_p2[13:4]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_129_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_584_cast_reg_366[10 : 8] <= tmp_584_cast_fu_149_p1[10 : 8];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_29_fu_153_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_585_cast_reg_379[11 : 0] <= tmp_585_cast_fu_174_p1[11 : 0];
    end
end
...
assign a_assign_2_fu_313_p2 = (tmp2_cast_fu_295_p1 + tmp_286_i_cast_fu_277_p1);

assign a_assign_3_fu_319_p2 = (tmp_34_fu_299_p4 + tmp_35_fu_309_p1);

assign a_assign_s_fu_255_p2 = ($signed(t_1_i_fu_250_p2) - $signed(t_22_cast_fu_247_p1));
...
assign i_25_fu_135_p2 = (i_reg_107 + 3'd1);

assign j_2_fu_159_p2 = (j_reg_118 + 9'd1);

assign t_14_fu_219_p2 = ($signed(tmp1_cast_fu_215_p1) + $signed(t_cast_fu_183_p1));

assign t_15_fu_241_p2 = (tmp_285_i_cast_cast_fu_233_p3 + t_14_fu_219_p2);

assign t_1_i_fu_250_p2 = (32'd261887 + v_vec_coeffs_load_reg_390);

assign t_22_cast_fu_247_p1 = t_15_reg_395;
...
assign tmp2_fu_289_p2 = (tmp_585_fu_281_p3 ^ 1'd1);

assign tmp_285_i_cast_cast_fu_233_p3 = ((tmp_583_fu_225_p3[0:0] === 1'b1) ? 24'd523776 : 24'd0);

assign tmp_286_i_cast_fu_277_p1 = tmp_584_fu_267_p4;

assign tmp_287_i_cast_fu_335_p1 = tmp_287_i_reg_406;

assign tmp_288_i_fu_338_p2 = ($signed(24'd8118530) + $signed(t_15_reg_395));
...
assign tmp_581_fu_169_p2 = (tmp_30_cast_fu_165_p1 + tmp_584_cast_reg_366);

assign tmp_582_fu_187_p4 = {{v_vec_coeffs_q0[31:19]}};

assign tmp_583_fu_225_p3 = t_14_fu_219_p2[32'd23];

assign tmp_584_cast_fu_149_p1 = tmp_s_fu_141_p3;

assign tmp_584_fu_267_p4 = {{a_assign_s_fu_255_p2[31:19]}};

assign tmp_585_cast_fu_174_p1 = tmp_581_fu_169_p2;

assign tmp_585_fu_281_p3 = u_fu_261_p2[32'd31];

assign tmp_fu_129_p2 = ((i_reg_107 == 3'd5) ? 1'b1 : 1'b0);

assign tmp_i_cast_fu_205_p1 = tmp_i_fu_197_p3;

assign tmp_i_fu_197_p3 = {{tmp_582_fu_187_p4}, {9'd0}};

assign tmp_s_fu_141_p3 = {{i_reg_107}, {8'd0}};

assign u_fu_261_p2 = ($signed(32'd4294967295) + $signed(a_assign_s_fu_255_p2));

assign v0_vec_coeffs_address0 = tmp_585_cast_reg_379;

assign v0_vec_coeffs_d0 = a0_write_assign_fu_343_p2;

assign v1_vec_coeffs_address0 = tmp_585_cast_reg_379;

assign v1_vec_coeffs_d0 = a_assign_3_reg_401;

assign v_vec_coeffs_address0 = tmp_585_cast_fu_174_p1;

always @ (posedge ap_clk) begin
    tmp_584_cast_reg_366[7:0] <= 8'b00000000;
    tmp_584_cast_reg_366[11] <= 1'b0;
    tmp_585_cast_reg_379[63:12] <= 52'b0000000000000000000000000000000000000000000000000000;
end
