...
set C_modelArgList {
	...
	{ tr int 8 regular {array 2760 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ tr_address0 sc_out sc_lv 12 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tr_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "tr", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	tr { ap_memory {  { tr_address0 mem_address 1 12 }  { tr_ce0 mem_ce 1 1 }  { tr_we0 mem_we 1 1 }  { tr_d0 mem_din 1 8 } } }
	s1_vec_coeffs { ap_memory {  { s1_vec_coeffs_address0 mem_address 1 10 }  { s1_vec_coeffs_ce0 mem_ce 1 1 }  { s1_vec_coeffs_we0 mem_we 1 1 }  { s1_vec_coeffs_d0 mem_din 1 32 }  { s1_vec_coeffs_address1 mem_address 1 10 }  { s1_vec_coeffs_ce1 mem_ce 1 1 }  { s1_vec_coeffs_we1 mem_we 1 1 }  { s1_vec_coeffs_d1 mem_din 1 32 } } }
