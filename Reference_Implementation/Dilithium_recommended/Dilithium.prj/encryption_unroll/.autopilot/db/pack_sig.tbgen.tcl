...
set C_modelArgList {
	{ sig int 8 regular {array 2760 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ sig_address0 sc_out sc_lv 12 signal 0 } 
...
set Spec2ImplPortList { 
	sig { ap_memory {  { sig_address0 mem_address 1 12 }  { sig_ce0 mem_ce 1 1 }  { sig_we0 mem_we 1 1 }  { sig_d0 mem_din 1 8 }  { sig_q0 mem_dout 0 8 } } }
