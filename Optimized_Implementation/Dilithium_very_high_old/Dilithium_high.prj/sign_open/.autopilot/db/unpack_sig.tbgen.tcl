...
set C_modelArgList {
	...
	{ c_coeffs int 23 regular {array 256 { 0 3 } 0 1 }  }
	{ sig int 8 regular {array 3425 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "z_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "c_coeffs", "interface" : "memory", "bitwidth" : 23, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ c_coeffs_d0 sc_out sc_lv 23 signal 2 } 
	{ sig_address0 sc_out sc_lv 12 signal 3 } 
	{ sig_ce0 sc_out sc_logic 1 signal 3 } 
	{ sig_q0 sc_in sc_lv 8 signal 3 } 
	{ sig_address1 sc_out sc_lv 12 signal 3 } 
...
set Spec2ImplPortList { 
	...
	c_coeffs { ap_memory {  { c_coeffs_address0 mem_address 1 8 }  { c_coeffs_ce0 mem_ce 1 1 }  { c_coeffs_we0 mem_we 1 1 }  { c_coeffs_d0 mem_din 1 23 } } }
