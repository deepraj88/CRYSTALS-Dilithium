...
set Spec2ImplPortList { 
	...
	b_coeffs { ap_memory {  { b_coeffs_address0 mem_address 1 8 }  { b_coeffs_ce0 mem_ce 1 1 }  { b_coeffs_q0 mem_dout 0 32 }  { b_coeffs_address1 mem_address 1 8 }  { b_coeffs_ce1 mem_ce 1 1 }  { b_coeffs_q1 mem_dout 0 32 } } }
}
set moduleName poly_add_1
set isTaskLevelControl 1
set isCombinational 0
