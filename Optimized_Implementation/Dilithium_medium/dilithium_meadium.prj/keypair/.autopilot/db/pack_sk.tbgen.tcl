...
set Spec2ImplPortList { 
	...
	s1_vec_coeffs { ap_memory {  { s1_vec_coeffs_address0 mem_address 1 10 }  { s1_vec_coeffs_ce0 mem_ce 1 1 }  { s1_vec_coeffs_q0 mem_dout 0 23 }  { s1_vec_coeffs_address1 mem_address 1 10 }  { s1_vec_coeffs_ce1 mem_ce 1 1 }  { s1_vec_coeffs_q1 mem_dout 0 23 } } }
	s2_vec_coeffs { ap_memory {  { s2_vec_coeffs_address0 mem_address 1 10 }  { s2_vec_coeffs_ce0 mem_ce 1 1 }  { s2_vec_coeffs_q0 mem_dout 0 23 }  { s2_vec_coeffs_address1 mem_address 1 10 }  { s2_vec_coeffs_ce1 mem_ce 1 1 }  { s2_vec_coeffs_q1 mem_dout 0 23 } } }
	t0_vec_coeffs { ap_memory {  { t0_vec_coeffs_address0 mem_address 1 10 }  { t0_vec_coeffs_ce0 mem_ce 1 1 }  { t0_vec_coeffs_q0 mem_dout 0 24 }  { t0_vec_coeffs_address1 mem_address 1 10 }  { t0_vec_coeffs_ce1 mem_ce 1 1 }  { t0_vec_coeffs_q1 mem_dout 0 24 } } }
}
set moduleName pack_sk
set isTaskLevelControl 1
set isCombinational 0
