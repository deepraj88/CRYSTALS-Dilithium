...
set C_modelArgList {
	{ w_vec_coeffs int 32 regular {array 1024 { 0 3 } 0 1 }  }
...
set Spec2ImplPortList { 
	w_vec_coeffs { ap_memory {  { w_vec_coeffs_address0 mem_address 1 10 }  { w_vec_coeffs_ce0 mem_ce 1 1 }  { w_vec_coeffs_we0 mem_we 1 1 }  { w_vec_coeffs_d0 mem_din 1 32 } } }
