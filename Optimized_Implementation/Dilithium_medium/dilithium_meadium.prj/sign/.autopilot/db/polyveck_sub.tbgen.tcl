...
set Spec2ImplPortList { 
	w_vec_coeffs { ap_memory {  { w_vec_coeffs_address0 mem_address 1 10 }  { w_vec_coeffs_ce0 mem_ce 1 1 }  { w_vec_coeffs_q0 mem_dout 0 32 }  { w_vec_coeffs_address1 mem_address 1 10 }  { w_vec_coeffs_ce1 mem_ce 1 1 }  { w_vec_coeffs_we1 mem_we 1 1 }  { w_vec_coeffs_d1 mem_din 1 32 } } }
	u_vec_coeffs { ap_memory {  { u_vec_coeffs_address0 mem_address 1 10 }  { u_vec_coeffs_ce0 mem_ce 1 1 }  { u_vec_coeffs_q0 mem_dout 0 32 } } }
}
