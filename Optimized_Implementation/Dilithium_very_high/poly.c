...
void poly_freeze(poly *a) {
  ...
  poly_freeze_label6:for(i = 0; i < N; ++i)
...
void poly_add(poly *c, const poly *a, const poly *b)  {
  ...
  poly_add_label21:for(i = 0; i < N; ++i)
...
void poly_sub(poly *c, const poly *a, const poly *b) {
  ...
  poly_sub_label22:for(i = 0; i < N; ++i)
...
void poly_shiftl(poly *a, unsigned int k) {
  ...
  poly_shiftl_label23:for(i = 0; i < N; ++i)
    a->coeffs[i] <<= k;
}
...
void poly_uniform(poly *a, unsigned char *buf) {
  ...
  ctr = pos = 0;
  poly_uniform_label24:while(ctr < N) {
    t  = buf[pos++];
...
#error "rej_gamma1m1() assumes GAMMA1 - 1 fits in 19 bits"
  ...
  ctr = pos = 0;
  rej_gamma1m1_label26:while(ctr < len) {
    t  = buf[pos];
...
#if ETA <= 3
  polyeta_pack_label27:for(i = 0; i < N/8; ++i) {
...
#if ETA <= 3
  polyeta_unpack_label28:for(i = 0; i < N/8; ++i) {
...
#error "polyt1_pack() assumes D == 14"
  ...
  polyt1_pack_label29:for(i = 0; i < N/8; ++i) {
...
void polyt0_pack(unsigned char *r, const poly *a) {
  ...
  polyt0_pack_label30:for(i = 0; i < N/4; ++i) {
...
void polyt0_unpack(poly *r, const unsigned char *a) {
  ...
  polyt0_unpack_label31:for(i = 0; i < N/4; ++i) {
...
#error "polyz_pack() assumes GAMMA1 <= 2^{19}"
  ...
  polyz_pack_label32:for(i = 0; i < N/2; ++i) {
    /* Map to {0,...,2*GAMMA1 - 2} */
...
void polyw1_pack(unsigned char *r, const poly *a) {
  ...
  polyw1_pack_label33:for(i = 0; i < N/2; ++i)
