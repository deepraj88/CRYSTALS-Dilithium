...
void polyvecl_freeze(polyvecl *v) {
  ...
  polyvecl_freeze_label20:for(i = 0; i < L; ++i)
    poly_freeze(v->vec+i);
}
...
void polyvecl_add(polyvecl *w, const polyvecl *u, const polyvecl *v) {
  ...
  polyvecl_add_label19:for(i = 0; i < L; ++i)
...
void polyvecl_ntt(polyvecl *v) {
  ...
  polyvecl_ntt_label18:for(i = 0; i < L; ++i)
    poly_ntt(v->vec+i);
}
                                          ...
                                          const polyvecl *v) 
{
  ...
  polyvecl_pointwise_acc_invmontgomery_label16:for(i = 1; i < L; ++i) {
    poly_pointwise_invmontgomery(&t, u->vec+i, v->vec+i);
    poly_add(w, w, &t);
  }

  polyvecl_pointwise_acc_invmontgomery_label17:for(i = 0; i < N; ++i)
...
int polyvecl_chknorm(const polyvecl *v, uint32_t bound)  {
  ...
  polyvecl_chknorm_label15:for(i = 0; i < L; ++i)
...
void polyveck_freeze(polyveck *v)  {
  ...
  polyveck_freeze_label14:for(i = 0; i < K; ++i)
    poly_freeze(v->vec+i);
}
...
void polyveck_sub(polyveck *w, const polyveck *u, const polyveck *v) {
  ...
  polyveck_sub_label12:for(i = 0; i < K; ++i)
...
void polyveck_neg(polyveck *v) { 
  ...
  polyveck_neg_label11:for(i = 0; i < K; ++i)
    poly_neg(v->vec+i);
}
...
void polyveck_shiftl(polyveck *v, unsigned int k) { 
  ...
  polyveck_shiftl_label10:for(i = 0; i < K; ++i)
...
void polyveck_ntt(polyveck *v) {
  ...
  polyveck_ntt_label9:for(i = 0; i < K; ++i)
    poly_ntt(v->vec+i);
}
...
void polyveck_invntt_montgomery(polyveck *v) {
  ...
  polyveck_invntt_montgomery_label8:for(i = 0; i < K; ++i)
...
int polyveck_chknorm(const polyveck *v, uint32_t bound) {
  ...
  polyveck_chknorm_label7:for(i = 0; i < K; ++i)
    ret |= poly_chknorm(v->vec+i, bound);
...
void polyveck_power2round(polyveck *v1, polyveck *v0, const polyveck *v) {
  ...
  for(i = 0; i < K; ++i)
    polyveck_power2round_label5:for(j = 0; j < N; ++j)
...
void polyveck_use_hint(polyveck *w, const polyveck *u, const polyveck *h) {
  ...
  for(i = 0; i < K; ++i)
    polyveck_use_hint_label6:for(j = 0; j < N; ++j)
