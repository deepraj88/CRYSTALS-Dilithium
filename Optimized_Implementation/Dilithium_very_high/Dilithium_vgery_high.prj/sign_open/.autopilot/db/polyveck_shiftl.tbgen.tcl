...
set C_modelType { void 0 }
set C_modelArgList {
	{ v_vec_coeffs int 32 regular {array 1536 { 1 0 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
# RTL Port declarations: 
...
set Spec2ImplPortList { 
	v_vec_coeffs { ap_memory {  { v_vec_coeffs_address0 mem_address 1 11 }  { v_vec_coeffs_ce0 mem_ce 1 1 }  { v_vec_coeffs_q0 mem_dout 0 32 }  { v_vec_coeffs_address1 mem_address 1 11 }  { v_vec_coeffs_ce1 mem_ce 1 1 }  { v_vec_coeffs_we1 mem_we 1 1 }  { v_vec_coeffs_d1 mem_din 1 32 } } }
}
