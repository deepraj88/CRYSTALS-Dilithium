...
set Spec2ImplPortList { 
	a_coeffs { ap_memory {  { a_coeffs_address0 mem_address 1 11 }  { a_coeffs_ce0 mem_ce 1 1 }  { a_coeffs_we0 mem_we 1 1 }  { a_coeffs_d0 mem_din 1 32 }  { a_coeffs_q0 mem_dout 0 32 }  { a_coeffs_address1 mem_address 1 11 }  { a_coeffs_ce1 mem_ce 1 1 }  { a_coeffs_we1 mem_we 1 1 }  { a_coeffs_d1 mem_din 1 32 }  { a_coeffs_q1 mem_dout 0 32 } } }
