...
void poly_freeze(poly *a) {
  ...
  poly_freeze_label24:for(i = 0; i < N; ++i)
...
void poly_add(poly *c, const poly *a, const poly *b)  {
  ...
  poly_add_label25:for(i = 0; i < N; ++i)
...
void poly_sub(poly *c, const poly *a, const poly *b) {
  ...
  poly_sub_label33:for(i = 0; i < N; ++i)
...
void poly_neg(poly *a) {
  ...
  poly_neg_label32:for(i = 0; i < N; ++i)
...
void poly_shiftl(poly *a, unsigned int k) {
  ...
  poly_shiftl_label31:for(i = 0; i < N; ++i)
    a->coeffs[i] <<= k;
}
...
void poly_pointwise_invmontgomery(poly *c, const poly *a, const poly *b) {
  ...
  poly_pointwise_invmontgomery_label30:for(i = 0; i < N; ++i)
...
int poly_chknorm(const poly *a, uint32_t B) {
  ...
  poly_chknorm_label29:for(i = 0; i < N; ++i) {
...
void poly_uniform(poly *a, unsigned char *buf) {
  ...
  ctr = pos = 0;
  poly_uniform_label40:while(ctr < N) {
    t  = buf[pos++];
                      ...
                      unsigned char nonce)
{
  ...
  poly_uniform_eta_label28:for(i= 0; i < SEEDBYTES; ++i)
    inbuf[i] = seed[i];
...
#error "rej_gamma1m1() assumes GAMMA1 - 1 fits in 19 bits"
  ...
  ctr = pos = 0;
  rej_gamma1m1_label42:while(ctr < len) {
    t  = buf[pos];
                           ...
                           uint16_t nonce)
{
  ...
  poly_uniform_gamma1m1_label27:for(i = 0; i < SEEDBYTES + CRHBYTES; ++i)
    inbuf[i] = seed[i];
...
#else
  polyeta_pack_label34:for(i = 0; i < N/2; ++i) {
...
#else
  polyeta_unpack_label35:for(i = 0; i < N/2; ++i) {
...
#error "polyt1_pack() assumes D == 14"
  ...
  polyt1_pack_label43:for(i = 0; i < N/8; ++i) {
...
void polyt1_unpack(poly *r, const unsigned char *a) {
  ...
  polyt1_unpack_label44:for(i = 0; i < N/8; ++i) {
...
void polyz_unpack(poly *r, const unsigned char *a) {
  ...
  polyz_unpack_label48:for(i = 0; i < N/2; ++i) {
...
void polyw1_pack(unsigned char *r, const poly *a) {
  ...
  polyw1_pack_label26:for(i = 0; i < N/2; ++i)
