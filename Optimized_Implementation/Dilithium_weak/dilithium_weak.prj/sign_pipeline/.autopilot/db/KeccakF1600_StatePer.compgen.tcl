...
set ID 16
set hasByteEnable 0
set MemName KeccakF1600_Statecud
...
set TrueReset 0
set IsROM 1
set ROMData { "000000" "000001" "111110" "011100" "011011" "100100" "101100" "000110" "110111" "010100" "000011" "001010" "101011" "011001" "100111" "101001" "101101" "001111" "010101" "001000" "010010" "000010" "111101" "111000" "001110" }
...
set ID 17
set hasByteEnable 0
set MemName KeccakF1600_StatedEe
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 64
set AddrRange 32
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data \
    op interface \
    ports { data_address0 { O 5 vector } data_ce0 { O 1 bit } data_we0 { O 1 bit } data_d0 { O 64 vector } data_q0 { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename state \
    op interface \
    ports { state_address0 { O 5 vector } state_ce0 { O 1 bit } state_we0 { O 1 bit } state_d0 { O 64 vector } state_q0 { I 64 vector } state_address1 { O 5 vector } state_ce1 { O 1 bit } state_q1 { I 64 vector } } \
} "
} else {
