...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1558", "EstimateLatencyMax" : "1561",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1558", "Max" : "1561"}
	, {"Name" : "Interval", "Min" : "1558", "Max" : "1561"}
]}
...
set Spec2ImplPortList { 
	w_vec_coeffs { ap_memory {  { w_vec_coeffs_address0 mem_address 1 11 }  { w_vec_coeffs_ce0 mem_ce 1 1 }  { w_vec_coeffs_q0 mem_dout 0 32 }  { w_vec_coeffs_address1 mem_address 1 11 }  { w_vec_coeffs_ce1 mem_ce 1 1 }  { w_vec_coeffs_we1 mem_we 1 1 }  { w_vec_coeffs_d1 mem_din 1 32 } } }
	u_vec_coeffs { ap_memory {  { u_vec_coeffs_address0 mem_address 1 11 }  { u_vec_coeffs_ce0 mem_ce 1 1 }  { u_vec_coeffs_q0 mem_dout 0 32 } } }
}
